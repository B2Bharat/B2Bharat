	...
	<li><button type="button" class="btn view-more-btn-3" id="btn-p2">Next</button></li>
                        ...
                        <div class="tab-pane" role="tabpanel" id="step3">
						  ...
						  <div class="row form-group add-image">
                            <label class="col-sm-3 label-title">Upload Photos <small style="color:red;">(image size should be 200x200)</small><span class="required">*</span></label>
                            <div class="col-sm-9">
                          ...
                          <div class="row form-group add-title">
						   ...
						   <div class="row form-group add-image">
                            <label class="col-sm-3 label-title">Product Brochures <small style="color:red;">(image size should be 200x200)</small></label>
                            <div class="col-sm-9">
                              <div class="upload-section">
                                <label class="upload-image" for="upload-image-six">
								<div class=""><img src="" id="img_div5"></img></div>
									<input type="file" name="brch" id="upload-image-six" accept="image/*" onchange="img_validate('upload-image-six',200,200,5,3,'img_div5');">
                                </label>										
                              </div>
                            </div>
                          </div>
