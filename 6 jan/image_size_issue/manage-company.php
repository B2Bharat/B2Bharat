                    ...
                    <div class="wizard-inner">
                      ...
                      <ul class="nav nav-tabs" role="tablist">
                        ...
                        <li role="presentation" class="text-center  active">
                          ...
                          <p class="register-info">Introduction of Company</p>
                        ...
                        <li role="presentation" class="disabled text-center">
						  ...
						  <p class="register-info">Company <br> Information</p>
                        ...
                        <li role="presentation" class="disabled text-center">
                          ...
                          <p class="register-info">Trade and <br> Production </p>
                        ...
                        <li role="presentation" class="disabled text-center">
                          ...
                          <p class="register-info">Information and Policies </p>
                        ...
                        <li role="presentation" class="disabled text-center">
                          ...
                          <p class="register-info">Category and <br> Images </p>
                      ...
                      <div class="tab-content well" >
                        ...
                        <div class="tab-pane active" role="tabpanel" id="step1">
                          ...
                          <div class="row form-group add-title">
                            ...
                            <label class="col-sm-3 label-title">Name of Your Store <span class="required">*</span></label>
	...
	<li><button type="button" class="btn view-more-btn-3" id="btn-mc1">Save and continue</button></li>
                        ...
                        <div class="tab-pane" role="tabpanel" id="step2">
                          ...
                          <div class="row form-group add-title">
                            ...
                            <label class="col-sm-3 label-title">Street<span class="required">*</span></label>
                          ...
                          <h4>Production Capacity & Scope</h4>
                          ...
                          <div class="row form-group add-title">
                            ...
                            <label class="col-sm-3 label-title">Date Established<span class="required">*</span></label>
                          ...
                          <div class="row form-group model-name">
                            ...
                            <label class="col-sm-3 label-title">Annual Revenue</label>
                          ...
                          <div class="row form-group add-title">
                            ...
                            <label class="col-sm-3 label-title">Detailed Company Introduction</label>
                          ...
                          <div class="row form-group add-title">
                            ...
                            <label class="col-sm-3 label-title">Company Policy <span class="required">*</span></label>
                          ...
                          <div class="row form-group add-title">
                            ...
                            <label class="col-sm-3 label-title">Payment Terms & Method</label>
                          ...
                          <div class="row form-group add-title">
                            ...
                            <label class="col-sm-3 label-title">Quality Control Policy</label>
						  ...
						  <?$COM_terms = isset($COM['terms_con'])?$COM['terms_con']:'';?>
                            ...
                            <label class="col-sm-3 label-title">Terms and Conditions <span class="required">*</span></label>
                          ...
                          <div class="row form-group add-title">
                            ...
                            <label class="col-sm-3 label-title">Closest Keywords to get found</label>
...
<ul class="list-inline pull-right">
	...
	<li><button type="button" class="btn view-more-btn-3" id="btn-mc2">Save and continue</button></li>
                        ...
                        <div class="tab-pane" role="tabpanel" id="step3">
                          ...
                          <h4>Trade & Production Information</h4>
                          ...
                          <div class="row form-group add-title">
                            ...
                            <label class="col-sm-3 label-title">Major Product(s) you sell (For Sellers) separated by commas(,)</label>
                          ...
                          <div class="row form-group add-title">
                            ...
                            <label class="col-sm-3 label-title">Major Product(s) you buy (For Buyers)</label>
                          ...
                          <div class="row form-group add-title">
                            ...
                            <label class="col-sm-3 label-title">Main Products<span class="required">*</span></label>
                          ...
                          <div class="row form-group add-title">
                            ...
                            <label class="col-sm-3 label-title">Main Products 2</label>
                          ...
                          <div class="row form-group add-title">
                            ...
                            <label class="col-sm-3 label-title">Main Products 3</label>
                          ...
                          <div class="row form-group add-title">
                            ...
                            <label class="col-sm-3 label-title">Main Products 4</label>
                          ...
                          <div class="row form-group add-title">
                            ...
                            <label class="col-sm-3 label-title">Other Products You Sell</label>
                          ...
                          <div class="row form-group add-title">
                            ...
                            <label class="col-sm-3 label-title">Factory Location <span class="required">*</span></label>
                          ...
                          <div class="row form-group">
                            ...
                            <label class="col-sm-3">Do you Accept order through our site<span class="required">*</span></label>
                          ...
                          <div class="row form-group">
                            ...
                            <label class="col-sm-3">Have you attended or planned to attend any trade shows?<span class="required">*</span></label>
	...
	<li><button type="button" class="btn view-more-btn-3 btn-info-full" id="btn-mc3">Save and continue</button></li>
                        ...
                        <div class="tab-pane" role="tabpanel" id="complete">
                          ...
                          <div class="row form-group model-name">
                            ...
                            <label class="col-sm-3 label-title">Annual Sales Volume<span class="required">*</span></label>
	...
	<li><button type="button" class="btn view-more-btn-3 btn-info-full" id="btn-mc4">Save and continue</button></li>
                        ...
                        <div class="tab-pane" role="tabpanel" id="step5">
                          ...
                          <div class="row form-group model-name">
                            ...
                            <label class="col-sm-3 label-title">Choose a category to appear your listing<span class="required">*</span></label>
                          ...
                          <div class="row form-group add-image">
                            ...
                            <label class="col-sm-3 label-title">Company Logo <small style="color:red">(image should be 200x200)</small> <span class="required">*</span></label>
                          ...
                          <div class="row form-group add-image">
                            ...
                            <label class="col-sm-3 label-title">Avatar pictures <small style="color:red">(image should be minimum 200x200)</small><span class="required">*</span></label>
                            ...
                            <div class="col-sm-9">
                              ...
                              <div class="upload-section">
                                ...
                                <input type="file" id="upload-image-two" name="COM_avatar" accept="image/*" onchange="img_validate('upload-image-two',200,200,1,1,'img_div2')">
                          ...
                          <div class="row form-group add-image">
                            ...
                            <label class="col-sm-3 label-title">Top Banner Image <small style="color:red">(image should be 200x200)</small><span class="required">*</span></label>
                            ...
                            <div class="col-sm-9">
                              ...
                              <div class="upload-section">
                                ...
                                <input type="file" id="upload-image-three" name="COM_banner" accept="image/*" onchange="img_validate('upload-image-three',200,200,5,3,'img_div3')">
