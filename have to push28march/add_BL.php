...
if(isset($BL_submit)) {	
	...
	$isUploaded = $com_obj->upload_image('BL_product_img',$NgImg,100,100,5,3,"uploads/BL_images/banner1/",$acn);
	if($isUploaded){
	...
	$isUploaded = $com_obj->upload_image('BL_product_img2',$NgImg,100,100,5,3,"uploads/BL_images/banner2/",$acn);
	if($isUploaded){
		$NgImg=$com_obj->img_Name;
		$set.=",photo2='$NgImg'";
	}else{
