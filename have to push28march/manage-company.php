                         ...
                         <div class="row form-group add-title">
                          ...
                          <div class="row form-group add-title">
							...
							<?$COM_intro = isset($COM['company_intro'])?$COM['company_intro']:'';?>
                                                        ...
                                                        <textarea class="form-control tiny" maxlength="1000" id="COM_intro" placeholder="Enter Company Brief Description !!Character maxlength should up to 1000" required title="Character maxlength should up to 1000" rows="3" name="COM_intro"><?echo $COM_intro;?></textarea>
                          ...
                          <div class="row form-group add-title">
							...
							<?$COM_policy = isset($COM['company_policy'])?$COM['company_policy']:'';?>
                                                        ...
                                                        <textarea class="form-control tiny" id="company_policy" maxlength="9000" placeholder="Enter Company detailed Description !!Character maxlength should up to 9000" rows="3" name="COM_policy" id="policy"><?echo $COM_policy;?></textarea>
                           ...
                           <div class="row form-group add-title">
							...
							<?$prod_portfolio = isset($COM['prod_portfolio'])?$COM['prod_portfolio']:'';?>
                                                        ...
                                                        <textarea maxlength="2000" id="prod_portfolio" required title="Enter Product Portfolio!!Character maxlength should up to 2000" placeholder="Enter Product Portfolio upto 6000 chatacters"class="form-control tiny" rows="3" name="prod_portfolio"><?echo $prod_portfolio;?></textarea>
                          ...
                          <div class="row form-group add-title">
							...
							<?$COM_pterms = isset($COM['payment_terms'])?$COM['payment_terms']:'';?>
                                                        ...
                                                        <textarea maxlength="6000"  title="Enter Awards and Testimonials!!Character maxlength should up to 6000" placeholder="Enter Awards & Testimonials upto 6000 chatacters"class="form-control tiny" rows="3" name="COM_pterms"><?echo $COM_pterms;?></textarea>
                          ...
                          <div class="row form-group add-title">
                            ...
                            <div class="col-sm-9">
                              ...
                              <textarea   title="Enter Quality & Compliance upto 6000 chatacters"  placeholder="Enter Quality & Compliance upto 6000 chatacters" maxlength="6000" minlength="1"  class="form-control tiny" rows="3" name="COM_qcountrol"><?echo $COM_qcountrol;?></textarea>
						  ...
						  <?$COM_terms = isset($COM['terms_con'])?$COM['terms_con']:'';?>
                            ...
                            <div class="col-sm-9">
                                ...
                                <textarea class="form-control tiny" maxlength="6000"  title="Enter Infrastructure & Facilities upto 6000 chatacters" placeholder="Enter Infrastructure & Facilities upto 6000 chatacters" rows="3" name="COM_terms" id="terms"><?echo $COM_terms;?></textarea>
...
<!--								<option value="">select</option>-->
                          ...
                          <div class="row form-group add-image">
                           ...
                           <div class="row form-group add-image">
                            ...
                            <label class="col-sm-3 label-title">Company Brochure <small style="color:red">(1000x600)</small></label>
							...
							<div class="col-xs-6 row">
								...
								<img src="<?php if(!empty($COM_brochure)){?><?echo $siteurl;?>/uploads/company/brochure/<?echo $COM_brochure;?><?php }?>" id="img_div4" width="100" height="80" <?if($COM_banner==''){?>style='display:none;'<?}?>>
