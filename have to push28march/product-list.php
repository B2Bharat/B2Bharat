...
?>
		...
		<div class="col-md-4 product_sec" style="display: table-cell;">    
			   ...
			   <div class="col-md-6 pr_img">
			        <?php if($ownerweburl!='') {  ?>
					<h2><a target="_blank"  href="<?php $link = $ownerweburl;$link = (0 === strpos($link, 'http')) ? $link : 'http://' . $link; echo $link;?>"><? echo substr($pname,0,30); ?></a></h2>
					<?php }else{ ?>
					<h2><a target="_blank" href="<? echo $siteurl; ?>/product-detail/<? echo $encid; ?>/<? echo $perma; ?>"><? echo substr($pname,0,30); ?></a></h2>
