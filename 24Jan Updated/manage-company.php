                        ...
                        <div class="tab-pane active" role="tabpanel" id="step1">
                          ...
                          <div class="row form-group">
                           ...
                           <div class="row form-group add-title">
                            ...
                            <label class="col-sm-3 label-title">Year of Registration</label>
                          ...
                          <div class="row form-group model-name">
                            ...
                            <label class="col-sm-3 label-title">Total No. of Employees</label>
                          ...
                          <div class="row form-group model-name">
                            ...
                            <label class="col-sm-3 label-title">Total Annual Revenue</label>
                           ...
                           <div class="row form-group add-title">
                            ...
                            <label class="col-sm-3 label-title">Add Contact Person</label>

                            <div class="col-sm-9">

							<?$COM_lowner=isset($COM['legal_owner_name'])?$COM['legal_owner_name']:'';?>	

                                                        <input type="text" name="COM_lowner" maxlength="60" class="form-control" id="text" placeholder="" value="<?echo $COM_lowner;?>">
                          ...
                          <div class="row form-group model-name">
                            ...
                            <label class="col-sm-3 label-title">Business Type<span class="required">*</span></label>
                          ...
                          <div class="row form-group add-title">
							...
							<?$COM_package = isset($COM['package_det'])?$COM['package_det']:'';?>
                              ...
                              <textarea name="COM_package" max="110" class="form-control" rows="3"><?echo $COM_package;?></textarea>
                        ...
                        <div class="tab-pane" role="tabpanel" id="step2">
                         ...
                         <div class="row form-group add-title">
                            ...
                            <div class="col-sm-9">
                              ...
                              <input type="text" name="pan_no" class="form-control" id="pan_no" placeholder="Enter PAN No" value="<?echo isset($COM['pan_no'])?$COM['pan_no']:'';?>">
                            ...
                            <label class="col-sm-3 label-title">Registration No.<span class="required">*</span></label>

                            <div class="col-sm-9">

                              <input type="text" name="reg_no" class="form-control" id="reg_no" placeholder="Enter Registration No" value="<?echo isset($COM['reg_no'])?$COM['reg_no']:'';?>">
                            ...
                            <label class="col-sm-3 label-title">Registration Auhority.<span class="required">*</span></label>

                            <div class="col-sm-9">

                              <input type="text" name="reg_auth" class="form-control" id="reg_auth" placeholder="Enter Registration Authority" value="<?echo isset($COM['reg_auth'])?$COM['reg_auth']:'';?>">
                            ...
                            <label class="col-sm-3 label-title">CIN No..<span class="required">*</span></label>

                            <div class="col-sm-9">

                              <input type="text" name="cin_no" class="form-control" id="cin_no" placeholder="Enter CIN No" value="<?echo isset($COM['cin_no'])?$COM['cin_no']:'';?>">
                            ...
                            <label class="col-sm-3 label-title">TAN No.<span class="required">*</span></label>

                            <div class="col-sm-9">

                              <input type="text" name="tan_no" class="form-control" id="tan_no" placeholder="Enter TAN No" value="<?echo isset($COM['tan_no'])?$COM['tan_no']:'';?>">
                            ...
                            <label class="col-sm-3 label-title">Service Tax No.<span class="required">*</span></label>

                            <div class="col-sm-9">

                              <input type="text" name="service_tax_no" class="form-control" id="service_tax_no" placeholder="Enter Service Tax No" value="<?echo isset($COM['service_tax_no'])?$COM['service_tax_no']:'';?>">
                            ...
                            <label class="col-sm-3 label-title">Excise Reg.No.<span class="required">*</span></label>

                            <div class="col-sm-9">

                              <input type="text" name="excise_reg_no" class="form-control" id="excise_reg_no" placeholder="Enter Excise Reg. No" value="<?echo isset($COM['excise_reg_no'])?$COM['excise_reg_no']:'';?>">
                            ...
                            <label class="col-sm-3 label-title">TIN/VAT No.<span class="required">*</span></label>

                            <div class="col-sm-9">

                              <input type="text" name="vat_no" class="form-control" id="vat_no" placeholder="Enter TIN/VAT No" value="<?echo isset($COM['vat_no'])?$COM['vat_no']:'';?>">
                            ...
                            <label class="col-sm-3 label-title">DGFT/E No.<span class="required">*</span></label>

                            <div class="col-sm-9">

                              <input type="text" name="dgft_no" class="form-control" id="dgft_no" placeholder="Enter DGFT/E No" value="<?echo isset($COM['dgft_no'])?$COM['dgft_no']:'';?>">
                            ...
                            <label class="col-sm-3 label-title">CST No.<span class="required">*</span></label>

                            <div class="col-sm-9">

                              <input type="text" name="cst_no" class="form-control" id="cst_no" placeholder="Enter CST No" value="<?echo isset($COM['cst_no'])?$COM['cst_no']:'';?>">
                            ...
                            <label class="col-sm-3 label-title">SSI/MSME No.<span class="required">*</span></label>

                            <div class="col-sm-9">

                              <input type="text" name="ssimsme_no" class="form-control" id="ssimsme_no" placeholder="Enter SSI/MSME No" value="<?echo isset($COM['ssimsme_no'])?$COM['ssimsme_no']:'';?>">
                            ...
                            <label class="col-sm-3 label-title">EPF No.<span class="required">*</span></label>

                            <div class="col-sm-9">

                              <input type="text" name="epf_no" class="form-control" id="epf_no" placeholder="Enter EPF No" value="<?echo isset($COM['epf_no'])?$COM['epf_no']:'';?>">
                            ...
                            <label class="col-sm-3 label-title">ESI No.<span class="required">*</span></label>

                            <div class="col-sm-9">

                              <input type="text" name="esi_no" class="form-control" id="esi_no" placeholder="Enter ESI No" value="<?echo isset($COM['esi_no'])?$COM['esi_no']:'';?>">
                            ...
                            <label class="col-sm-3 label-title">SCT No.<span class="required">*</span></label>

                            <div class="col-sm-9">

                              <input type="text" name="sct_no" class="form-control" id="sct_no" placeholder="Enter SCT No" value="<?echo isset($COM['sct_no'])?$COM['sct_no']:'';?>">
                            ...
                            <label class="col-sm-3 label-title">DNB No.<span class="required">*</span></label>

                            <div class="col-sm-9">

                              <input type="text" name="dnb_no" class="form-control" id="dnb_no" placeholder="Enter DNB No" value="<?echo isset($COM['dnb_no'])?$COM['dnb_no']:'';?>">
                            ...
                            <label class="col-sm-3 label-title">RBI No..<span class="required">*</span></label>

                            <div class="col-sm-9">

                              <input type="text" name="rbi_no" class="form-control" id="rbi_no" placeholder="Enter RBI No" value="<?echo isset($COM['rbi_no'])?$COM['rbi_no']:'';?>">
                            ...
                            <label class="col-sm-3 label-title">FSSAI-LISCENE No.<span class="required">*</span></label>

                            <div class="col-sm-9">

                              <input type="text" name="fssai_liscene_no" class="form-control" id="fssai_liscene_no" placeholder="Enter FSSAI-LISCENE No." value="<?echo isset($COM['fssai_liscene_no'])?$COM['fssai_liscene_no']:'';?>">
                            ...
                            <label class="col-sm-3 label-title">NSIC No.<span class="required">*</span></label>

                            <div class="col-sm-9">

                              <input type="text" name="nsic_no" class="form-control" id="nsic_no" placeholder="Enter NSIC No" value="<?echo isset($COM['nsic_no'])?$COM['nsic_no']:'';?>">
                            ...
                            <label class="col-sm-3 label-title">SST No.<span class="required">*</span></label>

                            <div class="col-sm-9">

                              <input type="text" name="sst_no" class="form-control" id="store_name" placeholder="Enter SST No" value="<?echo isset($COM['sst_no'])?$COM['sst_no']:'';?>">
                          ...
                          <div class="row form-group add-title">
                            ...
                            <label class="col-sm-3 label-title">Company Brief Description</label>

                            <div class="col-sm-9">

							<?$COM_intro = isset($COM['company_intro'])?$COM['company_intro']:'';?>

                                                        <textarea class="form-control" maxlength="1000" placeholder="Enter Company Brief Description !!Character maxlength should up to 1000" required title="Character maxlength should up to 1000" rows="3" name="COM_intro"><?echo $COM_intro;?></textarea>
                          ...
                          <div class="row form-group add-title">
							...
							<?$COM_policy = isset($COM['company_policy'])?$COM['company_policy']:'';?>
                                                        ...
                                                        <textarea class="form-control" maxlength="9000" placeholder="Enter Company detailed Description !!Character maxlength should up to 9000" rows="3" name="COM_policy" id="policy"><?echo $COM_policy;?></textarea>
                          ...
                          <div class="row form-group add-title">
							...
							<?$COM_pterms = isset($COM['payment_terms'])?$COM['payment_terms']:'';?>
                                                        ...
                                                        <textarea maxlength="6000" required title="Enter Awards and Testimonials!!Character maxlength should up to 6000" placeholder="Enter Awards & Testimonials upto 6000 chatacters"class="form-control" rows="3" name="COM_pterms"><?echo $COM_pterms;?></textarea>
                          ...
                          <div class="row form-group add-title">
                            ...
                            <div class="col-sm-9">
                              ...
                              <textarea  required title="Enter Quality & Compliance upto 6000 chatacters"  placeholder="Enter Quality & Compliance upto 6000 chatacters" maxlength="6000" minlength="1"  class="form-control" rows="3" name="COM_qcountrol"><?echo $COM_qcountrol;?></textarea>
						  ...
						  <?$COM_terms = isset($COM['terms_con'])?$COM['terms_con']:'';?>
                            ...
                            <label class="col-sm-3 label-title">Infrastructure & Facilities <span class="required">*</span></label>

                            <div class="col-sm-9">

                                <textarea class="form-control" maxlength="6000" required title="Enter Infrastructure & Facilities upto 6000 chatacters" placeholder="Enter Infrastructure & Facilities upto 6000 chatacters" rows="3" name="COM_terms" id="terms"><?echo $COM_terms;?></textarea>
                          ...
                          <div class="row form-group add-title">
							...
							<?$COM_keyword = isset($COM['close_keyword'])?$COM['close_keyword']:'';?>
                                                        ...
                                                        <textarea class="form-control"  maxlength="600"  placeholder="Enter Keywords"required title="Enter kewords upto 600 character" rows="3" name="COM_keyword"><?echo $COM_keyword;?></textarea>
                          ...
                          <div class="row form-group add-title">
							...
							<?$COM_mdesc = isset($COM['meta_desc'])?$COM['meta_desc']:'';?>
                                                        ...
                                                        <textarea maxlength="600" placeholder="Enter meta description" required title="Enter meta description upto 600 characters" class="form-control" rows="3" name="COM_mdesc"><?echo $COM_mdesc;?></textarea>
                        ...
                        <div class="tab-pane" role="tabpanel" id="step3">
                          ...
                          <div class="row form-group add-title">
							...
							<?$COM_mclients = isset($COM['main_clients'])?$COM['main_clients']:'';?>
                                                        ...
                                                        <textarea class="form-control" maxlength="1000" rows="3" name="COM_mclients"><?echo $COM_mclients;?></textarea>
                          ...
                          <div class="row form-group add-title">
							...
							<?$COM_mproduct1 = isset($COM['main_product1'])?$COM['main_product1']:'';?>
                                                        ...
                                                        <input type="text"  maxlength="60" class="form-control" id="main_product" name="COM_mproduct1" placeholder="" value="<?echo $COM_mproduct1;?>">
                          ...
                          <div class="row form-group add-title">
                            ...
                            <label class="col-sm-3 label-title">Main Product 2</label>

                            <div class="col-sm-9">

                              <?$COM_mproduct2 = isset($COM['main_product2'])?$COM['main_product2']:'';?>

                              <input type="text" class="form-control" maxlength="60" placeholder="Enter main product2" required title="Characters should upto 60"  id="text" name="COM_mproduct2"  value="<?echo $COM_mproduct2;?>">
                          ...
                          <div class="row form-group add-title">
                            ...
                            <label class="col-sm-3 label-title">Main Product 3</label>

                            <div class="col-sm-9">

                              <?$COM_mproduct3 = isset($COM['main_product3'])?$COM['main_product3']:'';?>

                              <input type="text"  maxlength="60" placeholder="Enter main product2" required title="Characters should upto 60" class="form-control" id="text" name="COM_mproduct3" placeholder="" value="<?echo $COM_mproduct3;?>">
                          ...
                          <div class="row form-group add-title">
                            ...
                            <label class="col-sm-3 label-title">Main Product 4</label>

                            <div class="col-sm-9">

                              <?$COM_mproduct4 = isset($COM['main_product4'])?$COM['main_product4']:'';?>

                              <input type="text"  maxlength="60" placeholder="Enter main product2" required title="Characters should upto 60" class="form-control" id="text" name="COM_mproduct4" placeholder="" value="<?echo $COM_mproduct4;?>">
                          ...
                          <div class="row form-group add-title">
                            ...
                            <label class="col-sm-3 label-title">Average Lead Time</label>							

                            <div class="col-sm-9">

							<?$COM_lead_time = isset($COM['avg_lead_time'])?$COM['avg_lead_time']:'';?>

                              <input type="text" class="form-control" maxlength="60" id="text" name="COM_lead_time" placeholder="" value="<?echo $COM_lead_time;?>">
                          ...
                          <div class="row form-group model-name">
                            ...
                            <label class="col-sm-3 label-title">Compliance(s) you are maintaining<span class="required">*</span></label>
                           ...
                           <div class="row form-group">
                            ...
                            <label class="col-sm-3">Do you provide product samples ?<span class="required">*</span></label>
                          ...
                          <div class="row form-group">
                            ...
                            <label class="col-sm-3">Do you provide factory tours?<span class="required">*</span></label>
                          ...
                          <div class="row form-group add-title">
                            ...
                            <label class="col-sm-3 label-title">Factory Address <span class="required">*</span></label>

                            <div class="col-sm-9">

							 <?$COM_factory_loc = isset($COM['factory_location'])?$COM['factory_location']:'';?>

                                                         <input type="text" class="form-control"  maxlength="60" id="flocation" name="COM_factory_loc" placeholder="" value="<?echo $COM_factory_loc;?>">
                          ...
                          <div class="row form-group add-title">
                            ...
                            <div class="col-sm-9">
							 ...
							 <?$COM_factory_size = isset($COM['factory_size'])?$COM['factory_size']:'';?>
                              ...
                              <input type="text" class="form-control" id="text" name="COM_factory_size"  maxlength="60" placeholder="" value="<?echo $COM_factory_size;?>">
                           ...
                           <div class="row form-group add-title">
                            ...
                            <label class="col-sm-3 label-title">Production Capacity <span class="required">*</span></label>
                          ...
                          <div class="row form-group add-title">
                            ...
                            <label class="col-sm-3 label-title">Most Selling Product(s)[separated by comma(,)]</label>

                            <div class="col-sm-9">

							<?$COM_mproduct = isset($COM['major_product_sell'])?$COM['major_product_sell']:'';?>

                              <input type="text" class="form-control"  maxlength="110" id="text" name="COM_mproduct" placeholder="" value="<?echo $COM_mproduct;?>">
                          ...
                          <div class="row form-group add-title">
                            ...
                            <label class="col-sm-3 label-title">Most Buying Product(s)</label>

                            <div class="col-sm-9">

							<?$COM_bproduct = isset($COM['major_product_buy'])?$COM['major_product_buy']:'';?>

                              <input type="text" class="form-control" maxlength="110" id="text" name="COM_bproduct" placeholder="" value="<?echo $COM_bproduct;?>">
                         ...
                         <div class="row form-group add-title">
                            ...
                            <label class="col-sm-3 label-title">Export Year<span class="required">*</span></label>
                          ...
                          <div class="row form-group model-name">
                            ...
                            <label class="col-sm-3 label-title">Export Percentage<span class="required">*</span></label>
                           ...
                           <div class="row form-group add-title">
							...
							<?$COM_near_port = isset($COM['nearest_port'])?$COM['nearest_port']:'';?>
                                                        ...
                                                        <input type="text" class="form-control" maxlength="60" id="text" name="COM_near_port" placeholder="" value="<?echo $COM_near_port; ?>">
	...
	<li><button type="button" class="btn view-more-btn-3 btn-info-full" id="btn-mc3">Save and continue</button></li>
                        ...
                        <div class="tab-pane" role="tabpanel" id="complete">
                          ...
                          <div class="row form-group">
                            ...
                            <label class="col-sm-3">Company Certification<span class="required">*</span></label>
                        ...
                        <div class="tab-pane" role="tabpanel" id="step5">
                          ...
                          <div class="row form-group model-name">
							...
							<?$COM_cat = isset($COM['category'])?$COM['category']:'';?>
                              ...
                              <select class="form-control" name="COM_cat[]" multiple id="com_cat" style="height: 200px;">
                          ...
                          <div class="row form-group add-image">
                            ...
                            <label class="col-sm-3 label-title">Company Logo <small style="color:red">(200x200)</small> <span class="required">*</span></label>
                          ...
                          <div class="row form-group add-image">
                            ...
                            <label class="col-sm-3 label-title">Avatar pictures <small style="color:red">(300x300)</small><span class="required">*</span></label>
                          ...
                          <div class="row form-group add-image">
                            ...
                            <label class="col-sm-3 label-title">Top Banner Image <small style="color:red">(1000x600)</small><span class="required">*</span></label>
