                                    ...
                                    <fieldset>
                                        <div class="section postdetails">
                                            ...
                                            <div class="row form-group model-name">
                                                ...
                                                <div class="col-sm-9">
                                                    <input type="text" class="form-control" pattern="[a-z|A-z|0-9|\s]{1,30}" required title="Character range should upto 30 "  name="origin" id="model" value="<? echo $prod['place_of_origin']; ?>" required>	
                                                </div>
                                            </div>
                                            ...
                                            <div class="row form-group model-name">
                                                ...
                                                <div class="col-sm-9">
                                                    <input type="text" class="form-control" pattern="[a-z|A-z|0-9|\s]{1,30}" required title="Character range should upto 30 " name="specif" id="model" value="<? echo $prod['specifications']; ?>" required>	
                                                </div>
                                            </div>
                                            ...
                                            <div class="row form-group model-name">
                                                ...
                                                <div class="col-sm-9">
                                                    <input type="text" class="form-control" pattern="[a-z|A-z|0-9|\s]{1,30}" required title="Character range should upto 30 " name="certif" id="model" value="<? echo $prod['certificates']; ?>" required>	
                                                </div>
                                            </div>
                                            ...
                                            <div class="row form-group model-name">
                                                ...
                                                <div class="col-sm-9">
                                                    <input type="text" class="form-control" pattern="[a-z|A-z|0-9|\s]{1,30}" required title="Character range should upto 30 " name="bname" id="model" value="<? echo $prod['brand_name']; ?>" required>	
                                                </div>
                                            </div>
                                            ...
                                            <div class="row form-group model-name">
                                                ...
                                                <div class="col-sm-9">
                                                    <input type="text" class="form-control" pattern="[a-z|A-z|0-9|\s]{1,30}" required title="Character range should upto 30 " name="material" id="model" value="<? echo $prod['materials']; ?>" required>	
                                                </div>
                                            </div>
                                            ...
                                            <div class="row form-group model-name">
                                             ...
                                             <div class="row form-group model-name">
                                                ...
                                                <div class="col-sm-9">
                                                    <input type="text" class="form-control" pattern="[a-z|A-z|0-9|\s]{1,30}" required title="Character range should upto 30 " name="color" id="model" Value="<? echo $prod['color']; ?>">	
                                                </div>
                                            </div>
                                            ...
                                            <div class="row form-group model-name">
                                                ...
                                                <div class="col-sm-9">
                                                    <input type="text" class="form-control" pattern="[a-z|A-z|0-9|\s]{1,30}" required title="Character range should upto 30 " name="model" id="model" Value="<? echo $prod['mode_article_num']; ?>">	
                                                </div>
                                            </div>
                                             ...
                                             <div class="row form-group model-name">
                                                ...
                                                <div class="col-sm-9">
                                                    <input type="text" pattern="[a-z|A-z|0-9|\s]{1,30}" required title="Character range should upto 30 " class="form-control" name="manufac" id="model" Value="<? echo $prod['manufacturers']; ?>">	
                                                </div>
                                            </div>
                                            <div class="row form-group model-name">
                                                    <label class="col-sm-3 label-title">Other related Information</label>
                                                    <div class="col-sm-9">
                                                            <textarea class="form-control" pattern="[a-z|A-z|0-9|\s]{1,5000}" required title="Character range should between 1  5000 " name="related" id="textarea" rows="5"><? echo $prod['other_relateditems']; ?></textarea>	
                                                    </div>
                                            </div>
