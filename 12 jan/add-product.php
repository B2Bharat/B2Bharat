                        ...
                        <div class="tab-pane" role="tabpanel" id="complete">
						  ...
						  <div class="row form-group add-title">
						    ...
						    <div class="row form-group add-title">
                                                     ...
                                                     <div class="col-sm-9">
                                                         <textarea class="form-control" placeholder="Enter Description!!!  characters should between 50 to 900 " minlength="50" maxlength="900" required title="range of characters should between 50 to 900 " name="prod_gdes" rows="5"><? echo @$prod_gdes; ?></textarea>
                                                     </div>
                                                   </div>
						  ...
						  <div class="row form-group add-title">
                            ...
                            <div class="col-sm-9">
                                <textarea class="form-control"  placeholder="Enter Description!!!  characters should between 50 to 900 " minlength="50" maxlength="900" required title="range of characters should between 50 to 900 "  name="b_des" rows="5"><? echo @$b_des; ?></textarea>
                            </div>
                          </div>
						  ...
						  <div class="row form-group add-title">
                            ...
                            <div class="col-sm-9">
                              <textarea required class="form-control" placeholder="Enter Description!!!  characters should upto 900 "  name="d_des" id="d_des" rows="5"><? echo @$d_des; ?></textarea>
                            </div>
                          </div>
						  ...
						  <div class="row form-group add-title">
                            ...
                            <div class="col-sm-9">
                                <input type="text" class="form-control"  maxlength="30" name="origin" id="text" placeholder="" value="<? echo @$origin; ?>">
                            </div>
                          </div>
