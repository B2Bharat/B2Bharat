...
<!--                        <div class="contact-with">
						    ...
						    <table class="table tbl-brder table-striped"  style="width:100%;">
							        <tbody>
										...
										<tr>
											...
											<td><strong>:</strong></td>
											<td><?echo ucwords($cinfo['street']).' , '.$cinfo['zip_code'];?></td>
										</tr>
									</tbody>
							</table>
						</div>
            ...
            <div class="description-info">
               <div class="row" oncontextmenu="return false;" id="test" onmousedown='return false;' onselectstart='return false;'>
                  <!-- description -->
                  <div class="col-md-8">
                     <div class="description" oncontextmenu="return false;" id="test" onmousedown='return false;' onselectstart='return false;'>
                     ...
                     <div class="adpost-details">
					  ...
					  <!-- Nav tabs -->
                                          <ul class="nav nav-tabs"  role="tablist" oncontextmenu="return false;" id="test" onmousedown='return false;' onselectstart='return false;'  >
                                              <li role="presentation" class="active" ><a href="#tc" aria-controls="tc" role="tab" data-toggle="tab"><i  class="fa fa-gavel"></i> &nbsp; Company Profile</a></li>
					  ...
					  <div role="tabpanel" class="tab-pane active" id="tc">
						...
						<div class=" col-md-12 well">
                                                      <div class="santosh" >
                                                        <h4>Company Detail Description</h4>
                                                        <p><?echo $cinfo['company_policy'];?></p>
                                                    </div>
                                                     <div class="santosh" > 
                                                            <h4> Award And Testimonials</h4>
...
<!--                                                           <label>Company Logo</label>-->
							    <img src="<?echo $siteurl;?>/uploads/company/logo/<?echo $cinfo['logo'];?>" alt="" height="200" width="250"  class="img-respocive zm-in">
							</div>
							<div class="col-sm-3">
<!--                                                              <label>Company Avatar Image</label>-->
							    <img src="<?echo $siteurl;?>/uploads/company/avatar/<?echo $cinfo['avatar'];?>" alt=""  height="200" width="250"  class="img-respocive zm-in">
							</div>
                                                      <div class="col-sm-3">
<!--                                                          <label>Company Banner Image</label>-->
							    <img src="<?echo $siteurl;?>/uploads/company/banner/<?echo $cinfo['banner'];?>" alt="" height="200" width="250"  class="img-respocive zm-in">
                                                       ...
                                                       <div class="col-sm-3">
<!--                                                           <label>Company Image Brochure</label>-->
							    <img src="<?echo $siteurl;?>/uploads/company/brochure/<?echo $cinfo['COM_brochure'];?>" alt=""  height="200" width="250"  class="img-respocive zm-in">
							</div>
