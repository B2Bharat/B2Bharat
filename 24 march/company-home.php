...
$cinfo = $db->singlerec("select company.*,register.lname,register.country,register.fname,register.img,register.country as ucon,register.email,register.state as ustate,register.address as uaddress,register.zip_code as uzip from company,register where company.user_id = register.id AND company.id = '$cid'");
if(empty($cinfo)){
echo "<script>window.history.back();</script>";		
exit;
}
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="slider-text">
                        ...
                        <span class="icon"><i class="fa fa-map-marker"></i><a href="#"><? echo $city['city_name'];?></a></span>
...
<!--                        <ul>								<?PHP// if ($cinfo['email'] <> '') { ?> 
                                ...
                                <li><i class="fa fa-globe" aria-hidden="true"></i><a href="<?echo $cinfo['website'];?>" target="_blank"> <?echo $cinfo['website'];?></a></li> 
                                    <?PHP //} ?>  
                                        <?PHP //if ($cinfo['ucon'] <> '') { ?>
                                <li><i class="fa fa-map-marker" aria-hidden="true"></i> <?echo ucfirst($com_obj->getCountry($cinfo['ucon']));?></li>
                                 <?PHP } ?>
                        </ul>-->
...
<ul>
							...
							if($cinfo['email']<>'')
							 {?> 
							 <i class="fa fa-envelope-o" title ="company email" aria-hidden="true"></i><a href="mailto:<?echo $cinfo['email'];?>"> <?echo $cinfo['email'];?></a><br />
                        ...
                        <div class="embed-responsive embed-responsive-16by9">
						  <? $city=$db->singlerec("select city_name from city where city_auto_id='$cinfo[city]'"); ?>
...
<!--                                            <?
$gstno="GST NO:-";
echo $gstno.''.$cinfo['gst_no']."\n";

$panno="PAN NO:-";
echo $panno.''. $cinfo['pan_no']."\n";

$regno="REG NO:-";
echo !isset($regno).''.$cinfo['reg_no']."\n";
                                        ...
                                        <table class="table tbl-brder table-striped" >
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><strong>:</strong></td>
                                                    <td><?php
                                                            $Accptd_terms = explode(',', $cinfo['ad_terms']);
                                                            $Accptd_terms = array_unique($Accptd_terms);
                                                            $expt = '';
                                                            foreach ($PS_delivery as $key4 => $adt) {

                                                                if ($key4 > 0) {

                                                                    if (in_array($key4, $Accptd_terms))
                                                                        $Comp_adt[] = $adt;
                                                                    else
                                                                        $Comp_adt[] = "";
                                                                }
                                                            ...
                                                            <?php echo implode(",", array_filter($Comp_adt)); ?>
                                                     </td>
                                        ...
                                        <table class="table tbl-brder table-striped" >
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                           <?php
                                                            $COM_Exportmarket = explode(',', $cinfo['export_markets']);
                                                            $COM_Exportmarket = array_unique($COM_Exportmarket);
                                                            $expt = '';
                                                            foreach ($PS_exportmarket as $key3 => $exp) {

                                                                if ($key3 > 0) {

                                                                    if (in_array($key3, $COM_Exportmarket))
                                                                        $expt[] = $exp;
                                                                    else
                                                                        $expt[] = "";
                                                                }
                                                            ...
                                                            <?php echo implode(",", array_filter($expt)); ?></td>
                                                </tr>
...
<!--                          <tr>
    ...
    <td><?echo $cinfo['main_product2'];?> </td>
                            ...
                            <div role="tabpanel" class="tab-pane" id="details">
                                ...
                                <div class="row">
                                    <div class="col-sm-3">
<!--                                        <label class="comp_img">Company Logo</label>-->
                                        <img src="<?echo $siteurl;?>/uploads/company/logo/<?echo $cinfo['logo'];?>"  height="200" width="250" alt="" class="img-respocive zm-in">
                                    </div>
                                    <div class="col-sm-3">
<!--                                         <label class="comp_img">Company Avater</label>-->
<img src="<?echo $siteurl;?>/uploads/company/avatar/<?echo $cinfo['avatar'];?>" height="200" width="250" alt="" class="img-respocive zm-in">
                                    </div>
                                    <div class="col-sm-3">
<!--                                        <label class="comp_img">Company Banner</label>-->
                                        <img src="<?echo $siteurl;?>/uploads/company/banner/<?echo $cinfo['banner'];?>" alt=""  height="200" width="250" class="img-respocive zm-in">
                                    </div>
                                    <div class="col-sm-3">
<!--                                        <label class="comp_img">Company Brochure Image</label>-->
                                        <img src="<?echo $siteurl;?>/uploads/company/brochure/<?echo $cinfo['COM_brochure'];?>" alt="" class="img-respocive zm-in">
                                    </div>
                                </div>
                            </div>
                  ...
                  <!--							<tr> 
                                                ...
                                                <tr> 
                                                    <td><b>
                                                            <?php
                                                            $COM_certificates = explode(',', $cinfo['certification']);
                                                            ...
                                                            <?php echo implode("<br>", array_filter($ccert)); ?></b></td>
<!--<td><input type="checkbox" checked></td>-->
                                                </tr>
          <!--<tr>
            <td><b>HACCP</b></td>
