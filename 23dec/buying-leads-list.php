<?
$tpTitle = 'B2Bharat.com - List of all Buying Leads';
$pgDesc = 'B2Bharat.com - List of all Buying Leads';
$pgKeywords = 'B2Bharat - List of all Buying Leads';
				...
				<div class="ad-item row ">
					<div class="item-image-box  col-sm-12 col-md-5">
						...
						<div class="ad-info">
							...
							<?}?>
							<p><b>Short Description :</b> <?echo substr($BL['det_desc'],0,80).'...';?></p>
						</div>						
					</div>	
					<div class="cars-ads-box col-sm-12 col-md-7">
						...
						<div class="ad-meta">
							<div class="meta-content">
								...
								<a href="<? echo $siteurl; ?>/buying-leads-detail/<? echo $perm; ?>/<? echo $com_obj->encid($BL['id']); ?>" class="btn view-more-btn-2-1 ml20">More Details </a>
