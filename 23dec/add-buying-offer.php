	...
	<li><button type="button" class="btn view-more-btn-3" id="btn-bl1">Save and continue</button></li>
                        ...
                        <div class="tab-pane" role="tabpanel" id="step2">
						  ...
						  <div class="row form-group add-image">
                            <label class="col-sm-3 label-title">Upload Image(1) <small style="color:red;"> (size 1000x600)</small></label>
                            <div class="col-sm-9">
                              <div class="col-xs-6">
						  ...
						  <div class="row form-group add-image">
						  <label class="col-sm-3 label-title">Upload Image(2) <small style="color:red;"> (size 1000x600)</small></label>
                            <div class="col-sm-9">
                              <div class="col-xs-6">
							  <div class="upload-section">
						  ...
						  <div class="row form-group add-image">
						  <label class="col-sm-3 label-title">Upload Image(3) <small style="color:red;"> (size 1000x600)</small></label>
                            <div class="col-sm-9">
								<div class="col-xs-6">
								  <div class="upload-section">
						  ...
						  <div class="row form-group add-image">
						  <label class="col-sm-3 label-title">Upload Image(4) <small style="color:red;"> (size 1000x600)</small></label>
						  ...
						  <div class="row form-group add-image">
						  <label class="col-sm-3 label-title">Upload Image(5) <small style="color:red;"> (size 1000x600)</small></label>
                            <div class="col-sm-9">
								<div class="col-xs-6">
								  <div class="upload-section">
						...
						<!--<div class="row form-group add-title"> 
						  ...
						  <div class="row form-group add-title">
                            ...
                            <div class="col-sm-9">
                                <textarea class="form-control" rows="5" name="BL_desc" placeholder="product description"  id="BL_desc" required value="<?echo isset($bl_info['det_desc'])?$bl_info['det_desc']:'';?>" ></textarea>
                            </div>
                          </div>
