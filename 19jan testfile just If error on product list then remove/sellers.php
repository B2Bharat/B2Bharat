...
$sql="select a.id,a.user_id,a.name,a.country,a.type,a.business_type,a.website,a.company_intro,a.create_date,a.logo from company as a, register as b where a.user_id = b.id AND b.mem_pack!='1' AND (a.type='seller' or a.type='both') AND a.active_status='1' order by id desc"; 
