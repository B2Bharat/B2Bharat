				...
				<div class="row">
                  <div class="col-md-8">
					...
					<?php if($cinfo['phone']!="" && $cinfo['phone']!="0"){ ?>
					    <label class="col-sm-4">Company Number: </label>
					...
					<div class=" form-group model-name">
						...
						<label class="col-sm-8"><?echo $cinfo['zip_code'];?></label>
					</div>
                  </div>
				  ...
				  <div class="col-md-4">
					...
					<div class=" form-group model-name">
						...
						<label class="col-sm-8"><?echo ucfirst($cinfo['fname']).' '.ucfirst($cinfo['lname']);?></label>
					</div>
                  ...
                  <div class="row tablerew">
                    <div class="respocive-table">
                      ...
                      <table class="table tbl-brder table-striped"  style="width:100%;">
                        <tbody>
                          <tr>
                            <td><strong>Name of Your Stores</strong></td>
                            <td><strong>:</strong></td>
                            <td><?echo ucwords($cinfo['store_name']);?></td>
                          </tr>
                          <tr>
                            <td><strong>Main Products</strong></td>
                            <td><strong>:</strong></td>
                            <td><?echo $cinfo['main_product1'].', '.$cinfo['main_product2'];?></td>
                          </tr>
                          <tr>
                            <td><strong>Category of Company  </strong></td>
                            <td><strong>:</strong></td>
                        ...
                        <tr>
                            <td><strong>Language And Communication</strong></td>
                            <td><strong>:</strong></td>
                            <td><?echo $lan;?></td>
                          </tr>
                        </tbody>
            ...
            <div class="col-md-4">
              <div class="short-info">
                <ul>								<?PHP									if($cinfo['email']<>'')							 {?> 
                  ...
                  <li><i class="fa fa-map-marker" aria-hidden="true"></i> <?echo ucfirst($cinfo['ucon']);?></li> <?PHP } ?>
                </ul>
            ...
            <div class="well" style="padding-bottom:0;">
              <div class="adpost-details">
                ...
                <ul class="nav nav-tabs" role="tablist">
                  <li role="presentation" class="active"><a href="#pt" aria-controls="pt" role="tab" data-toggle="tab"><i class="fa fa-check-square"></i> &nbsp; Production Information</a></li>
				  <li role="presentation"><a href="#tm" aria-controls="tm" role="tab" data-toggle="tab"><i class="fa fa-check-square"></i> &nbsp; Trade & Market</a></li>
				  <li role="presentation" ><a href="#tc" aria-controls="tc" role="tab" data-toggle="tab"><i class="fa fa-gavel"></i> &nbsp; Company Terms and Policies</a></li>
					   ...
					   <table class="table tbl-brder table-striped" >
                        <tbody>
                          ...
                          <tr>
                            ...
                            <td><strong>:</strong></td>
                            <td><?echo date('Y',strtotime($cinfo['registration_date']));?></td>
                          </tr>
                          <tr>
                            <td><strong>Major Product(s) you  </strong></td>
                            <td><strong>:</strong></td>
