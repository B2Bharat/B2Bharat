												...
												<div class="form-group">
                                                    ...
                                                    <div class="row">
													   ...
													   <div class="radio">
														   ...
														   <input type="radio" name="prod_status" value="0" <? if($prod_status=="0") echo "checked"; ?>/>No&nbsp;&nbsp;</label>
														...
														<div class="radio"> 
														   ...
														   <input type="radio" name="featured" value="0" <? if($featured=="0") echo "checked"; ?>/>No&nbsp;&nbsp;</label>
