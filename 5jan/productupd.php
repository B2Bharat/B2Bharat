...
<div class="boxed">
                ...
                <div class="col-md-12">
					...
					<div class="col-md-6">
						...
						<label> Product No :<span class="text-danger">*</span></label>
                                                          ...
                                                          <input type="text" pattern="^[1-9][0-9]{0,4}" name="prod_no" id="prod_no" value="<? echo $prod_no; ?>" class="form-control" data-parsley-type="number" data-parsley-group="experience" data-parsley-required/>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-3">
                                                            ...
                                                            <input type="input" pattern="[a-z|A-z|0-9|\s]{1,40}" name="keyword1" class="form-control" value="<? echo $keyword1; ?>"data-parsley-group="experience" data-parsley-required/>
												...
												<div class="form-group">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-12">
                                                            ...
                                                            <textarea maxlength="900" name="prod_gdes"  id="prod_gdes" class="form-control" data-parsley-group="experience" data-parsley-required><? echo $prod_gdes; ?></textarea>
												...
												<div class="row">
                                                    ...
                                                    <div class="col-sm-12">
													 ...
													 <label> Product Brief Description :<span class="text-danger">*</span> </label>
                                                        ...
                                                        <textarea  minlength="400"  maxlength="900"  name="prod_briefdes" id="prod_briefdes" class="form-control" data-parsley-group="experience" data-parsley-required/><? echo $prod_briefdes; ?></textarea> 
												...
												<div class="form-group">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-12">
                                                            ...
                                                            <textarea minlength="400" maxlength="6000"   name="prod_detaildes" id="prod_detaildes" class="form-control" data-parsley-group="experience" data-parsley-required><? echo $prod_detaildes; ?></textarea>
												...
												<div class="form-group">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-3">
                                                            ...
                                                            <input maxlength="40" name="place_of_origin" id="place_of_origin" class="form-control" value="<? echo $place_of_origin; ?>">
 ...
 id="specifications" class="form-control" value="<? echo $specifications; ?>">
														 ...
														 <div class="col-md-3">
                                                            ...
                                                            <input maxlength="40" name="certificates" id="certificates" class="form-control" value="<? echo $certificates; ?>">
												...
												<div class="form-group">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-3">
                                                            ...
                                                            <input maxlength="40"  name="materials" id="materials" class="form-control" value="<? echo $materials; ?>">
														 ...
														 <div class="col-md-3">
                                                            ...
                                                            <input name="mode_article_num" minlength="10" maxlength="10" id="mode_article_num" class="form-control" value="<? echo $mode_article_num; ?>">
														 ...
														 <div class="col-md-3">
                                                            ...
                                                            <input name="manufacturers" maxlength="40" id="manufacturers" class="form-control" value="<? echo $manufacturers; ?>">
												...
												<div class="form-group">
                                                    ...
                                                    <div class="row">
														 ...
														 <div class="col-md-12">
                                                           ...
                                                           <textarea maxlength="400" name="packaging_details" id="packaging_details" class="form-control" /><? echo $packaging_details; ?></textarea>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="row">
														 ...
														 <div class="col-md-6">
                                                           ...
                                                           <input name="shipment" maxlength="400" id="shipment" class="form-control" value="<? echo $shipment; ?>"/>
												...
												<div class="form-group">
                                                    ...
                                                    <div class="row">
														 ...
														 <div class="col-md-6">
                                                           ...
                                                           <input  name="warranty_period" maxlength="400" id="warranty_period" class="form-control" value="<? echo $warranty_period; ?>"/>
