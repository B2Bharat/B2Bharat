							...
							<fieldset>
								<div class="section postdetails">
									...
									<div class="row form-group model-name">
									  ...
									  <div class="row form-group model-name">
										<label class="col-sm-3 label-title">Product Group Description<span class="required">*</span></label>
										<div class="col-sm-9">
											<textarea class="form-control" name="prod_gdes" id="textarea" rows="3" required><? echo $prod['prod_gdes']; ?></textarea>	
										</div>
									</div>
...
if(isset($ed_Prod)) {
	...
	$permalink=str_replace(" ", "-", $prod_group_name);
	...
	$prod_gdesprod_gdes=trim(addslashes($prod_gdesprod_gdes));
