  ...
  <div class="banner_outer">
          ...
          <div class="featured_slider_sec">
			...
			?>
              ...
              <li>
                <div class="cl_sec">
                  <h4 class="item-title"><a target="_blank" href="<? echo $siteurl; ?>/product-detail/<? echo $encid; ?>/<? echo $perm; ?>"><?echo (strlen($newprod['prod_name'])>14)?substr(ucwords($newprod['prod_name']),0,15).'...':ucwords($newprod['prod_name']);?></a></h4>
          ...
          <div class="featured_slider_sec">
			...
			<li>
                <div class="cl_sec">
                  <h4><?echo ucwords(substr($catrec['category_name'],0,30));?></h4>
