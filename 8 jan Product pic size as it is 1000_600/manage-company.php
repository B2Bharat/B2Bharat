	...
	<li><button type="button" class="btn view-more-btn-3 btn-info-full" id="btn-mc4">Save and continue</button></li>
                        ...
                        <div class="tab-pane" role="tabpanel" id="step5">
                          ...
                          <div class="row form-group add-image">
                            ...
                            <label class="col-sm-3 label-title">Avatar pictures <small style="color:red">(image should be 300x300)</small><span class="required">*</span></label>
                          ...
                          <div class="row form-group add-image">
                            ...
                            <label class="col-sm-3 label-title">Top Banner Image <small style="color:red">(image should be 1000x600)</small><span class="required">*</span></label>
