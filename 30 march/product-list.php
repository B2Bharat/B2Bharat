...
?>
		...
		<div class="col-md-4 product_sec">    
			<div class="prd_wrapper">
			   <div class="col-md-6 pr_img" style="width: 67%;">
					...
					echo $siteurl; ?>/product-detail/<? echo $encid; ?>/<? echo $perma; }?>"><? echo substr($pname,0,15); ?></a></h2>
                               <a target="_blank" href="<? echo $siteurl; ?>/product-detail/<? echo $encid; ?>/<? echo $perma; ?>" style="border-color:red; "><img src="<? echo $siteurl; ?>/uploads/product/1000x600/<? echo $prd['photo1']; ?>" alt="<? echo $pname;//$name; ?>" class="img-responsive" ></a>
			   </div>
			   <div class="col-md-6 pr_descript">
				 <p><? echo substr($prd['prod_briefdes'],0,120).'...'; ?>11111 </p>
			   </div>
...
<div class="col-md-4 product_sec companylist">    
			<div class="prd_wrapper">
			   ...
			   <div class="col-md-6 pr_img">
					<h2><a target="_blank" href="<?echo $siteurl;?>/company-detail/<?echo strtolower(str_replace(' ','-',$cinfo['name']));?>/<?echo $com_obj->encid($cinfo['id']);?>"><?echo ucfirst($cinfo['name']);?></a></h2>
			   ...
			   <div class="col-md-6 pr_descript">
				 <p>22222<?echo (strlen($cinfo['company_intro'])>200)?substr($cinfo['company_intro'],0,170).'...':ucfirst($cinfo['company_intro']);?> </p>
			   </div>
			</div>    
		   <div class="en_wrap">
				<div class="col-md-7 enqiry_sec">
...
<div class="col-md-4 product_sec byuinglist">    
			<div class="prd_wrapper">
			   ...
			   <div class="col-md-6 pr_img">
					<h2><a  target="_blank" href="<? echo $siteurl; ?>/buying-leads-detail/<? echo $perm; ?>/<? echo $com_obj->encid($BL['id']); ?>"><?echo ($BL['offer_name']>15)?ucfirst(substr($BL['offer_name'],0,16).'...'):$BL['offer_name'];?>saaS</a></h2>
			   ...
			   <div class="col-md-6 pr_descript">
				 <p>33333<?echo substr($BL['det_desc'],0,175).'...';?> </p>
			   </div>
			</div>    
		   <div class="en_wrap">
				<div class="col-md-7 enqiry_sec">
...
<div class="col-md-4 product_sec sellinglist">    
			<div class="prd_wrapper">
			   ...
			   <div class="col-md-6 pr_img">
					<h2><a target="_blank" href="<?echo $siteurl;?>/selling-leads-detail/<?echo strtolower(str_replace(' ','-',$SL['offer_name']));?>/<?echo $com_obj->encid($SL['id']);?>"><? echo ucwords($SL['offer_name']); ?></a></h2>
					
					
					
					 <a target="_blank" href="<?echo $siteurl;?>/selling-leads-detail/<?echo strtolower(str_replace(' ','-',$SL['offer_name']));?>/<?echo $com_obj->encid($SL['id']);?>"><img src="<?echo $logourl;?>" alt="Image" class="img-responsive"></a>
			   </div>
			   <div class="col-md-6 pr_descript">
				 <p>44444<?echo $des.'...';?> </p>
			   </div>
...
?>
		...
		<div class="col-md-4 product_sec" style="display: table-cell;">    
                    <div class="prd_wrapper"  >
                         <?php if($ownerweburl!='') {  ?>
                               <h4><a class="heading" target="_blank"   href="<?php $link = $ownerweburl;$link = (0 === strpos($link, 'http')) ? $link : 'http://' . $link; echo $link;?>"><? echo substr($pname,0,30); ?></a></h4>
					<?php }else{ ?>
					<h4><a class="heading" target="_blank" href="<? echo $siteurl; ?>/product-detail/<? echo $encid; ?>/<? echo $perma; ?>"><? echo substr($pname,0,30); ?></a></h2>
			   ...
			   <div class="col-md-6 pr_img vijay">
					...
					<a target="_blank" href="<?php $link = $ownerweburl;$link = (0 === strpos($link, 'http')) ? $link : 'http://' . $link; echo $link;?>"><img src="<? echo $siteurl; ?>/uploads/product/1000x600/<? echo $prd['photo1']; ?>" alt="<? echo $pname;//$name; ?>" class="img-responsive"></a>
					<?php }else{ ?>
			   ...
			   <div style="font-size:15px;" class="col-md-6 pr_descript">
                               <p style="font-size: 15px;"><? echo substr($prd['prod_briefdes'],0,120).'..'; ?></p>
			   </div>
			</div>    
		   <div class="en_wrap" style="margin-top: 0px;">
                       <strong> <h5 class="comheading" style="margin-left:14px;font-weight: bold;font-size: 16px;"><? echo substr($country['company_name'],0,35); ?></h5></strong>
                     
                     
				<div class="col-md-7 enqiry_sec">
				  <p><? echo substr($country['address'],0,19).'..'; ?></p>
                                  <? $city=$db->singlerec("select city_name from city where city_auto_id='$country[city]'"); ?>
                                  <h4 class="city"><? echo $city['city_name'];?></h4>
					<span><i class="fa fa-phone" aria-hidden="true"></i><? echo $country['mobile']; ?></span>		
				</div>
				<div class="col-md-5 cta_en">
					<button onclick="setToemail('<?echo $country['email'];?>','<?echo ucfirst($country['fname']);?>');" class="btn" data-toggle="modal" data-target="#send-an-inquiry" ><i class="fa fa-paper-plane-o" aria-hidden="true"></i>
				...
				<div class="row">
					...
					<div class="col-sm-6 col-md-6">				
						...
						foreach($prod_Lst as $prd){
							...
							$fcat=$db->singlerec("select category_name from category where id='".$prd['prod_category']."'");
							$cat=ucwords($fcat['category_name']);
                                                       $unit=$db->singlerec("select category_name from category where id='".$prd['prod_category']."'");
							$pname=ucwords($prd['prod_name']);
                                                         $unit=$db->singlerec("select unit_price from product where id='".$prd['id']."'");
                                                        $unit_price=ucwords($unit['unit_price']);
							if(41<(strlen($pname)))
								$pname=substr($pname,0,42)."...";
									...
									<div class="ad-meta1">
										<div class="meta-content1">
										   ...
										   ( Select )
                                                                                        ...
                                                                                        <a target="blank" href="<? echo $siteurl; ?>/product-detail/<? echo $encid; ?>/<? echo $prd['permalink']; ?>" class='btn view-more-btn-3' style="color:white;margin:0px;">Read more</a>
										</div>										
										<!-- item-info-right -->
