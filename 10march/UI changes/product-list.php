...
<div class="col-md-4 product_sec byuinglist">    
			<div class="prd_wrapper">
			   ...
			   <div class="col-md-6 pr_img">
					<h2><a target="_blank" href="<? echo $siteurl; ?>/buying-leads-detail/<? echo $perm; ?>/<? echo $com_obj->encid($BL['id']); ?>"><?echo ($BL['offer_name']>15)?ucfirst(substr($BL['offer_name'],0,16).'...'):$BL['offer_name'];?></a></h2>
...
?>
		...
		<div class="col-md-4 product_sec" style="display: table-cell;">    
		   ...
		   <div class="en_wrap">
				<div class="col-md-7 enqiry_sec">
                                    <h3><a target="_blank" href="<? echo $siteurl; ?>/product-detail/<? echo $encid; ?>/<? echo $perma; ?>"><? echo $country['company_name']; ?></a></h3>
					<!--<h3><? echo $country['company_name']; ?></h3>-->
					<p><? echo $country['address']; ?></p>
					<span><i class="fa fa-phone" aria-hidden="true"></i><? echo $country['mobile']; ?></span>		
				</div>
...
<!--                                                                                <div class="item-cat">
							...
							<a target="_blank" href="<? echo $siteurl; ?>/product-detail/<? echo $encid; ?>/<? echo $prd['permalink']; ?>" class='btn view-more-btn-3' style="color:white;margin:0px;">Read more</a>
										</div>										
										<!-- item-info-right -->
