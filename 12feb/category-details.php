							...
							<?if($mctot !=0){
								...
								foreach($subcatg_main as $mctot_oi){								
									...
									$Disp .=" <li><i class='fa fa-angle-right'></i> <a href='$sburl_oi'>$sbcatname_oi</a></li>";
                                                                ...
                                                                $tmpcatname=ucwords($catnam);
                                                                $tmpcatname=strtolower(str_replace(' ','-',$tmpcatname));
                                                                        
                                                                         
                                                                    $Disp .="<ul ><li class='dropdown' class='viewmore'><a  href='$siteurl/subcategories/$tmpcatname/$maincat_oi/$dd' class='btn btn-global'>View More1</a></li></ul>";
