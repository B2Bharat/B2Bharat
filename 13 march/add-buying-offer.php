                    ...
                    <div class="wizard-inner">
                      ...
                      <ul class="nav nav-tabs" role="tablist">
                        ...
                        <li role="presentation" class="disabled text-center" id="ch3">
                          ...
                          <p class="register-info">Proposal Details </p>
                        </li>
                        <li role="presentation" class="disabled text-center" id="ch4">
                          ...
                          <p class="register-info">Contact <br> Details </p>
                        </li>
	...
	<li><button type="button" class="btn view-more-btn-3" id="btn-bl1">Save and continue</button></li>
                        ...
                        <div class="tab-pane" role="tabpanel" id="step2">
                          ...
                          <div class="row form-group add-title">
                            <label class="col-sm-3 label-title">Name of Buying Offer<span class="required">*</span></label>
                            <div class="col-sm-9">
						  ...
						  <div class="row form-group add-image">
						  <label class="col-sm-3 label-title">Upload Product image(2) <small style="color:red;"> (Image size should be 1000x600)</small></label>
                            <div class="col-sm-9">
                              <div class="col-xs-6">
							  <div class="upload-section">
                                <label class="upload-image" for="upload-image-one2" style="width:40%">
									<input type="file" id="upload-image-one2" name="BL_product_img2" accept="image/*" onchange="img_validate('upload-image-one2',1000,600,5,3,'img_div2')"/>
                                </label>										
                              </div>
							  </div>
                            ...
                            <div class="col-sm-9 row">
							  ...
							  <div class="col-sm-6">
							     <select class="form-control" name="BL_buy_capacity_unit">
								  ...
								  <!--   <?echo $drop->get_dropdown($db,"select quantity,quantity from units where quantity!='' AND quantity is NOT NULL",$BL_m_per);?> -->
	...
	<li><button type="button" class="btn view-more-btn-3 btn-info-full" id="btn-bl3">Save and continue</button></li>
                        ...
                        <div class="tab-pane" role="tabpanel" id="complete">
						  ...
						  <div class="row form-group add-title">
                            ...
                            <div class="col-sm-9">
                              <input type="text" name="BL_com_name" class="form-control" id="text" value="<?echo isset($bl_info['company_name'])?$bl_info['company_name']:'';?>" placeholder="">
                            </div>
                          </div>
						  ...
						  <div class="row form-group add-title">
                            ...
                            <div class="col-sm-9">
                              <input type="text" name="BL_buss_type" class="form-control" id="text" value="<?echo isset($bl_info['businesstype'])?$bl_info['businesstype']:'';?>" placeholder="">
                            </div>
                          </div>
						  ...
						  <div class="row form-group add-title">
                            ...
                            <div class="col-sm-9">
                              <input type="text" name="BL_email" class="form-control" id="text" value="<?echo isset($bl_info['email'])?$bl_info['email']:'';?>" placeholder="">
                            </div>
                          </div>
						  ...
						  <div class="row form-group add-title">
                            ...
                            <div class="col-sm-9">
                              ...
                              <select class="form-control" name="BL_country">
							    <?
						  ...
						  <div class="row form-group add-title">
                            <label class="col-sm-3 label-title">Detailed Description</label>
                            <div class="col-sm-9">
  ...
  <ul class="list-inline pull-right">
	...
	<li><button type="button" class="btn view-more-btn-3 btn-info-full next-step">Save and continue</button></li>
       ...
       <!--                     <div class="col-sm-9 user-type">-->
							<!--<?$pneg = isset($bl_info['price_negotiable'])?$bl_info['price_negotiable']:'';?>-->
       <!--                     <?$com_obj->get_radio($PS_Negot,$pneg,'BL_negotiable');?>-->
       <!--                       </div>							  -->
       <!--                     </div>-->
