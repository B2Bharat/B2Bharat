<?
$tpTitle = 'Sellers | B2Bharat.com ,seller List,List of Fabrication Customers,Wholsaler List ';
$pgDesc = 'Sellers List in B2Bharat , List Of traders for Industrial Items,B2B Industrial Wholsaler, Indian Manufacturers List.';
$pgKeywords = 'Industrial Fabrication Search Result, Fabrication Result, Paint Sellers Product Information, List Of Packaging Machinery, Paint Manufacturing Client List, Automobile parts Manufacturers, Rubber and Plastic Suppliers, Safety product Suppliers';
...
$sql="select a.id,a.user_id,a.name,a.country,a.type,a.business_type,a.website,a.phone,a.company_intro,a.create_date,a.logo from company as a, register as b where a.user_id = b.id AND b.mem_pack!='1' AND (a.type='seller' or a.type='both') AND a.active_status='1' order by id desc"; 
