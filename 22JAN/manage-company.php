                         ...
                         <div class="row form-group add-title">
                          ...
                          <div class="row form-group add-title">
							...
							<?$COM_policy = isset($COM['company_policy'])?$COM['company_policy']:'';?>
                              ...
                              <textarea class="form-control" rows="3" name="COM_policy" id="policy"><?echo $COM_policy;?></textarea>
						  ...
						  <?$COM_terms = isset($COM['terms_con'])?$COM['terms_con']:'';?>
                            ...
                            <div class="col-sm-9">
                              ...
                              <textarea class="form-control" rows="3" name="COM_terms" id="terms"><?echo $COM_terms;?></textarea>
                        ...
                        <div class="tab-pane" role="tabpanel" id="step3">
                          ...
                          <div class="row form-group add-title">
                            ...
                            <div class="col-sm-9">
                              ...
                              <input type="text" class="form-control" id="text" name="COM_mproduct2" placeholder="" value="<?echo $COM_mproduct2;?>">
                          ...
                          <div class="row form-group add-title">
                            ...
                            <div class="col-sm-9">
                              ...
                              <input type="text" class="form-control" id="text" name="COM_mproduct3" placeholder="" value="<?echo $COM_mproduct3;?>">
                          ...
                          <div class="row form-group add-title">
                            ...
                            <div class="col-sm-9">
                              ...
                              <input type="text" class="form-control" id="text" name="COM_mproduct4" placeholder="" value="<?echo $COM_mproduct4;?>">
