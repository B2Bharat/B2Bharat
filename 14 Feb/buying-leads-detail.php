               ...
               <div class="row">
                  ...
                  <div class="col-md-5">
                     <div class="slider-text">                        
                        ...
                        <span class="icon"><i class="fa fa-map-marker"></i><a href="#">  <? echo ucfirst($BL_Det['country']); ?></a></span>
						<?
                     ...
                     <div class="short-info">
                          <ul>
							...
							<?PHP 							 if($BL_Det['website']<>'NULL')							 {?>							 <li><a href="<?echo $BL_Det['website'];?>" target="_blank"><i class="fa fa-globe" aria-hidden="true"></i> <? echo $BL_Det['website']; ?></a></li>							 <?PHP } ?>
														<li><i class="fa fa-map-marker" aria-hidden="true"></i> <? echo ucfirst($BL_Det['city']); ?></li>
						  </ul>
