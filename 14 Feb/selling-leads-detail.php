...
$SL_info = $db->singlerec("select selling_leads.*,company.type,company.language,company.website,register.fname,register.lname,register.company_number,register.email,register.country from selling_leads,company,register where selling_leads.user_id=company.user_id AND selling_leads.user_id=register.id AND selling_leads.id = '$slid'");
               ...
               <div class="row">
                  ...
                  <div class="col-md-5">
                     <div class="slider-text">                        
                        ...
                        <span class="icon"><i class="fa fa-map-marker"></i><a href="#"> <?echo ucfirst($SL_info['place_of_origin']);?></a></span>
                  ...
                  <div class="col-md-4">
                     <div class="short-info">
                          <ul>
							 ...
							 <li><i class="fa fa-map-marker" aria-hidden="true"></i> <?echo $SL_info['country'];?></li>
							<?PHP } ?>
