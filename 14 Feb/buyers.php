...
$sql="select a.id,a.user_id,a.name,a.country,a.type,a.business_type,a.website,a.company_intro,a.create_date,a.logo from company as a, register as b where a.user_id = b.id AND b.mem_pack!='1' AND (a.type='buyer' or a.type='both') AND a.active_status='1' order by id desc";
						...
						<div class="ad-item ad-item-2 row">
							<div class="item-info col-sm-12">
							  ...
							  <div class="ad-info ad-info-new-2">
								<a href="<?echo $siteurl;?>/company-detail/<?echo strtolower(str_replace(' ','-',$cinfo['name']));?>/<?echo $com_obj->encid($cinfo['id']);?>"><h3 class="item-price"><?echo ucfirst($cinfo['name']);?></h3></a>
