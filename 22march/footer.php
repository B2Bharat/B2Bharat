    ...
    <div class="modal-dialog modal-sm" role="document">
        <div class="modal-content">
            <div class="modal-header model-head">
                <button type="button" class="btn btn-danger" style="color:white; float:right;"  class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">×</span></button>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <form method="POST" id="single-eq" action="send-enquiry.php">
                            ...
                            <div class="form-group">
                                <label for="exampleInputPassword1">Company name <span class="required">*</span></label>
                                <input type="text" placeholder="Enter Your Company name" class="form-control form-height" id="exampleInputPassword1" name="enq_company"  required>
                            </div>
                            ...
                            <div class="form-group">
                             ...
                             <div class="form-group">
                                ...
                                <input type="text" placeholder="Enter Your Address" class="form-control form-height" id="exampleInputPassword1" name="enq_address"   required>
                            </div>
                             <div class="form-group">
                                <label for="exampleInputPassword1">City<span class="required">*</span></label>
                                <input type="text" placeholder="Enter Your city" class="form-control form-height" id="exampleInputPassword1" name="enq_city"   required>
                            </div>
                             <div class="form-group">
                                <label for="exampleInputPassword1">State<span class="required">*</span></label>
                                <input type="text" placeholder="Enter Your state" class="form-control form-height" id="exampleInputPassword1" name="enq_state"   required>
                            </div>
                            
                            <div class="form-group">
                                <label for="exampleInputPassword1">Mobile Number <span class="required">*</span></label>
...
<!--                                             <input type="hidden" name="enq_quantity2"  id="enq_quantity2" value="">-->
                            ...
                            <div class="form-group">
                                <label for="exampleInputPassword1">Requirement Details <span class="required">*</span></label>
                    ...
                    <div class="col-md-12">
                        <form method="POST" action="send-enquiry.php" id="enq-for">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" placeholder="Mobile Number" class="form-control form-height" id="exampleInputPassword1" name="enq_phone" maxlength="10"  pattern="[0-9]{10}" required>
                            </div>
                              <div class="form-group">
                                <label for="exampleInputsub">Subject</label>
