                ...
                <div class="col-md-12">
                    <section class="panel">
                        ...
                        <div class="panel-body">
                            <!-- START Form Wizard -->
                            <form class="form-horizontal form-bordered form-wizard" action="company_update.php" id="wizard-validate" method="post" enctype="multipart/form-data" nonvalidate/>
                                <!-- Wizard Container 1 -->
...
<?$COM_cat_title = isset($COM['category_title'])?$COM['category_title']:'';?>
                                    ...
                                    <div class="form-group">
                                     ...
                                     <div class="form-group">
                                        <label class="col-sm-2 control-label"> Company Brochure:</label>
                                        <div class="col-sm-6">
                                            <div class="upload-section">
                                                <label class="upload-image" for="upload-image-four">
                                                    <input type="file" id="upload-image-four" name="COM_brochure" accept="image/*" onchange="img_validate('upload-image-four', 1000, 600, 5, 3, 'img_div4')">
                                                </label>
                                            </div>
                                        </div>
                                        <?$COM_brochure = isset($COM['COM_brochure'])?$COM['COM_brochure']:'';?>
                                        <img src="<?echo $siteurl;?>/uploads/company/brochure/<?echo $COM_brochure;?>" id="img_div3" width="100" height="80" <?if($COM_brochure==''){?>style='display:none;'<?}?>>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <div class="row">
                                            <div class="col-md-6">
                                                ...
                                                <input type="text" name="COM_store_name" class="form-control" id="text" placeholder="" value="<?echo isset($COM['store_name'])?$COM['store_name']:'';?>"data-parsley-group="information" data-parsley-required>
                                            </div>
                                            <div class="col-md-6">
...
<!--                                              <div class="col-md-6">
                                                <label>Office Size:<span class="text-danger">*</span></label>
                                                ...
                                                <select class="form-control" name='COM_off_size' data-parsley-group="information" data-parsley-required>
...
<!--                                             <div class="col-md-4">
                                                <label>Total No.of Employees:<span class="text-danger">*</span></label>
                                                ...
                                                <label>Total No.of Employees:<span class="text-danger">*</span></label>
                                                <?$COM_emps = isset($COM['emp_count'])?$COM['emp_count']:'';?>
                                                <select class="form-control" name='COM_emps' data-parsley-group="information" data-parsley-required>
                                            ...
                                            <div class="col-md-6">
                                                <label>Total Annual Revenue:<span class="text-danger">*</span></label>
                                                <?$COM_annrev = isset($COM['ann_revenue'])?$COM['ann_revenue']:'';?>
                                                <select class="form-control" name='COM_annrev'data-parsley-group="information" data-parsley-required >
                                           ...
                                           <div class="col-md-6">
                                                ...
                                                <input type="text" name="COM_lowner" class="form-control" id="text" placeholder="" value="<?echo $COM_lowner;?>" data-parsley-group="information" data-parsley-required>
                                            </div>
                                           ...
                                           <div class="col-md-4">
                                                ...
                                                <select name="COM_btype[]" multiple class="form-control" data-parsley-group="other" data-parsley-required>
                                    ...
                                    <div class="form-group">
                                        <div class="row">
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <input type="text" name="COM_street" class="form-control" id="text" value="<?echo $COM_street;?>" data-parsley-group="information" data-parsley-required>
                                            </div>
                              ...
                              <select class="form-control" name="COM_state" id="state" Onchange="return get_city(this.value);" data-parsley-group="information" data-parsley-required>
...
<!--                                                <select class="form-control" name="COM_state" data-parsley-group="information" data-parsley-required
							 ...
							 <select class="form-control" name="COM_city" id="city"data-parsley-group="information" data-parsley-required>
...
<!--                                                <select class="form-control" name="COM_city" data-parsley-group="information" data-parsley-required
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <input type="text" name="COM_zip" class="form-control" id="text" placeholder="" pattern="^[1-9][0-9]{0,8}"  title="digits only up to 8 " value="<?echo $COM_zip;?>" data-parsley-group="information" data-parsley-required>
                                            </div>
                                            <div class="col-md-4">
                                                <label>Web Site:</label>
                                                <?$COM_site = isset($COM['website'])?$COM['website']:'';?>
                                                    <input type="text" pattern="/^(?:http(s)?:\/\/)?[\w.-]+(?:\.[\w\.-]+)+[\w\-\._~:/?#[\]@!\$&'\(\)\*\+,;=.]+$/" placeholder="format of url should be (https://www.domainname.com)"name="COM_site" class="form-control" id="text" placeholder="" value="<?echo $COM_site;?>" >
                                            </div>
                                             <div class="col-md-12">
                                    ...
                                    <div class="form-group">
                                        <div class="row">
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <input type="text" value="<? echo $COM_phone; ?>" name="COM_phone" id="COM_phone" class="form-control" data-parsley-type="number" data-parsley-length="[9,10]" data-parsley-group="information">
                                            </div>
                                            <div class="col-md-4">
                                                <label>Fax Number: </label>
                                                <?$COM_fax=isset($COM['fax'])?$COM['fax']:'';?>
                                                <input type="text" value="<? echo $COM_fax; ?>" name="COM_fax" id="COM_fax" class="form-control" data-parsley-type="number" data-parsley-length="[9,10]" data-parsley-group="information">
                                            </div>
                                        </div>
                                    </div>
                                     <div class="col-md-12">
                                ...
                                <div class="wizard-container">
                                    ...
                                    <div class="form-group">
                                        <div class="row">
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <input type="text" pattern="[a-z|A-z|0-9|\s]{1,60}" name="pan_no" class="form-control" id="text" placeholder="Enter Upto 60 character" value="<?echo $pan_no;?>" data-parsley-group="payment" data-parsley-required>
                                            </div>
                                            <div class="col-md-4">
                                                <label>Registration No:</label>
                                                <?$COM_zip = isset($COM['reg_no'])?$COM['reg_no']:'';?>
                                                <input type="text" pattern="[a-z|A-z|0-9|\s]{1,60}" name="reg_no" class="form-control"
                                                       data-parsley-group="information" id="text" maxlength="60" placeholder="" value="<?echo $reg_no;?>">
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-4">
                                   ...
                                   <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <div class="row">
                                            <div class="col-md-6">
                                                <label>Company Brief Description:<span class="text-danger">*</span></label>
                                                <?$COM_intro = isset($COM['company_intro'])?$COM['company_intro']:'';?>
                                                <textarea class="form-control"  maxlength="1000"rows="3" name="COM_intro" data-parsley-group="payment" data-parsley-required ><?echo $COM_intro;?></textarea>
                                            </div>
                                            <div class="col-md-6">
                                                <label>Company Detailed Description:<span class="text-danger">*</span> </label>
                                                <?$COM_policy = isset($COM['company_policy'])?$COM['company_policy']:'';?>
                                                <textarea class="form-control" maxlength="9000" placeholder="you can mention the details such as Our team!,WhyUs!,Vision!,Mission!,Goal!,Value!" rows="3" name="COM_policy"data-parsley-group="payment" data-parsley-required><?echo $COM_policy;?></textarea>
                                            </div>
                                             <div class="col-md-6">
                                                <label>Product Portfolia:<span class="text-danger">*</span></label>
                                                <?$prod_portfolio = isset($COM['prod_portfolio'])?$COM['prod_portfolio']:'';?>
                                                <textarea class="form-control" maxlength="2000" placeholder=" Enter Product Portfolia" rows="3" name="prod_portfolio"data-parsley-group="payment" data-parsley-required><?echo $prod_portfolio;?></textarea>
                                            </div>
                                    ...
                                    <div class="form-group">
                                        <div class="row">
                                            <div class="col-md-3">
                                                ...
                                                <input type="text"  maxlength="60" class="form-control" id="text" name="COM_mproduct1" value="<?echo $COM_mproduct1;?>" data-parsley-group="experience" data-parsley-required>
                                            </div>
                                            <div class="col-md-3">
                                                <label>Main Product 2:<span class="text-danger">*</span></label>
                                                <?$COM_mproduct2 = isset($COM['main_product2'])?$COM['main_product2']:'';?>
                                                <input type="text" maxlength="60" class="form-control" id="text" name="COM_mproduct2" value="<?echo $COM_mproduct2;?>" data-parsley-group="experience" data-parsley-required>
                                            </div>
                                            <div class="col-md-3">
                                                <label>Main Product 3:<span class="text-danger">*</span></label>
                                                <?$COM_mproduct3 = isset($COM['main_product3'])?$COM['main_product3']:'';?>
                                                <input type="text" maxlength="60" class="form-control" id="text" name="COM_mproduct3" value="<?echo $COM_mproduct3;?>" data-parsley-group="experience" data-parsley-required>
                                            </div>
                                            <div class="col-md-3">
                                                <label>Main Product 4:<span class="text-danger">*</span></label>
                                                <?$COM_mproduct4 = isset($COM['main_product4'])?$COM['main_product4']:'';?>
                                                <input type="text" maxlength="60" class="form-control" id="text" name="COM_mproduct4" value="<?echo $COM_mproduct4;?>" data-parsley-group="experience" data-parsley-required>
                                            </div>
                                    ...
                                    <div class="form-group">
                                        <div class="row">
                                            <div class="col-md-6">
                                              ...
                                              <div class="col-md-6">
                                                <label>Average Lead Time:<span class="text-danger">*</span></label>
                                                <?$COM_lead_time = isset($COM['avg_lead_time'])?$COM['avg_lead_time']:'';?>
                                                <input type="text" maxlength="110" class="form-control" id="text" name="COM_lead_time" placeholder="" value="<?echo $COM_lead_time;?>"data-parsley-group="experience" data-parsley-required>
                                            </div>
                                             <div class="form-group">
                                        <div class="row">
                                            <div class="col-md-12">
                                        ...
                                        <div class="row">
                                            ...
                                            <p class="text-muted"> </p>
                                             ...
                                             <div class="col-md-4">
                                                ...
                                                <input type="date" name="COM_start_yr" class="form-control"id="text" placeholder="" value="<?echo $COM_start_yr;?>" >
                                            </div>
                                            <div class="col-md-6">
...
<!--                                             <div class="col-md-6">
                                             ...
                                             <div class="col-md-6">
                                                ...
                                                <div class="checkbox">
                                                    ...
                                                    $ch="";?>
                                                    <div class="col-md-4">
                                                        <label for="<?echo $exmarket?>"><input type="checkbox" name="COM_exmarket[]" id="<?echo $exmarket;?>" value="<?echo $key;?>" <?echo $ch;?> ><?echo $exmarket;?></label>
                                                    </div>
