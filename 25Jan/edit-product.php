...
<!--                                                    <input type="text" class="form-control"  pattern="[a-z|A-z|0-9|\s]{1,40}" required title="Enter upto 40 characters" name="prod_group_name" id="text" value="<? echo $prod['prod_group_name']; ?>" required>-->
                                                    ...
                                                    <select class="form-control" name="prod_group_name" required>
                                                        ...
                                                        echo $drop->get_dropdown($db, "select prod_group_name,prod_group_name from product where prod_status='1'", $prod_group_name);
                                                        ?>
                                                    </select>
                                            ...
                                            <div class="row form-group add-title">
                                             ...
                                             <div class="row form-group add-title">
                                                ...
                                                <div class="col-sm-9">
                                                    <input type="text" class="form-control"  pattern="^[1-9][0-9]{0,10}" placeholder="Enter product No upto 10 digits only" maxlength="10" required title="Accept upto 10 digits"  name="prod_no" id="text" value="<? echo $prod['prod_no']; ?>" required>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row form-group model-name">
                                                ...
                                                <div class="col-sm-4">
                                                    <input type="text" class="form-control" maxlength="40"  required title="Accept upto 40 characters"  placeholder=" Enter keyword1" name="keyword" id="model" value="<? echo "$prod[keyword1]"; ?>" required>	
                                                </div>
                                              
                                                <div class="col-sm-5">
                                                    <input type="text" class="form-control" maxlength="40" required title="Accept upto 40 characters"  placeholder=" Enter keyword2" name="keyword" id="model" value="<? echo "$prod[keyword2]"; ?>" required>	
                                                </div>
                                            </div>
                                            ...
                                            <div class="row form-group model-name">
                                                ...
                                                <div class="col-sm-4">
                                                    <input type="text" class="form-control" maxlength="40" required title="Accept upto 40 characters"  placeholder=" Enterkeyword3" name="keyword" id="model" value="<? echo "$prod[keyword3]"; ?>" required>	
                                                </div>
                                                      
                                                <div class="col-sm-5">
                                                    <input type="text" class="form-control" maxlength="40" required title="Accept upto 40 characters"   placeholder=" Enter keyword3" name="keyword" id="model" value="<? echo "$prod[keyword4]"; ?>" required>	
                                                </div>
                                            </div>
                                            <!-    code by santosh-->
                                            <div class="row form-group model-name">
                                                ...
                                                <div class="col-sm-9">
                                                    <textarea class="form-control" name="prod_gdes"  placeholder="Enter Description!!!  characters should between 50 to 900 " minlength="50" maxlength="900" required title="Range of characters should between 50 to 900 " id="textarea" rows="3"><? echo $prod['prod_gdes']; ?></textarea>	
                                                </div>
                                            </div>
                                            ...
                                            <div class="row form-group model-name">
                                                ...
                                                <div class="col-sm-9">
                                                    <textarea class="form-control"  placeholder="Enter Description!!!  characters should between 50 to 900 " minlength="50" maxlength="900" required title="Range of characters should between 50 to 900 " name="b_des" id="textarea" rows="3"><? echo $prod['prod_briefdes']; ?></textarea>	
                                                </div>
                                            </div>
                                            ...
                                            <div class="row form-group model-name">
                                                ...
                                                <div class="col-sm-9">
                                                    <textarea class="form-control"  placeholder="Enter Description!!!  characters should between 50 to 900 " minlength="50" maxlength="900" required title="Range of characters should between 50 to 900 " name="d_des" id="textarea" rows="3" required><? echo $prod['prod_detaildes']; ?></textarea>	
                                                </div>
                                            </div>

                                            <div class="row form-group model-name">
                                                <label class="col-sm-3 label-title">Place of Origin<span class="required">*</span></label>
                                                <div class="col-sm-9">
                                                    <input type="text" class="form-control" maxlength="30" required title="Character range should upto 30 "  name="origin" id="model" value="<? echo $prod['place_of_origin']; ?>" required>	
                                                </div>
                                            </div>

                                            <div class="row form-group model-name">
                                                <label class="col-sm-3 label-title">Specification<span class="required">*</span></label>
                                                <div class="col-sm-9">
                                                    <input type="text" class="form-control" maxlength="30" required title="Character range should upto 30 " name="specif" id="model" value="<? echo $prod['specifications']; ?>" required>	
                                                </div>
                                            </div>

                                            <div class="row form-group model-name">
                                                <label class="col-sm-3 label-title">Certificates<span class="required">*</span></label>
                                                <div class="col-sm-9">
                                                    <input type="text" class="form-control" maxlength="30" required title="Character range should upto 30 " name="certif" id="model" value="<? echo $prod['certificates']; ?>" required>	
                                                </div>
                                            </div>
                                            ...
                                            <div class="row form-group model-name">
                                                ...
                                                <div class="col-sm-9">
                                                    <input type="text" class="form-control" maxlength="30" required title="Character range should upto 30 " name="bname" id="model" value="<? echo $prod['brand_name']; ?>" required>	
                                                </div>
                                            </div>

                                            <div class="row form-group model-name">
                                                <label class="col-sm-3 label-title">Materials/Ingredients<span class="required">*</span></label>
                                                <div class="col-sm-9">
                                                    <input type="text" class="form-control" maxlength="30" required title="Character range should upto 30 " name="material" id="model" value="<? echo $prod['materials']; ?>" required>	
                                                </div>
                                            </div>
                                            
                                            <div class="row form-group model-name">
                                                <label class="col-sm-3 label-title">HS Code<span class="required">*</span></label>
                                                <div class="col-sm-9">
                                                    <input type="text"  pattern="^[1-9][0-9]{0,9}" required title="Accepts upto 10 digits" class="form-control" name="hscode" id="model" value="<? echo $prod['hs_code']; ?>" required>	
                                                </div>
                                            </div>
                                             <div class="row form-group model-name">
                                                <label class="col-sm-3 label-title">Colour</label>
                                                <div class="col-sm-9">
                                                    <input type="text" class="form-control" maxlength="30" required title="Character range should upto 30 " name="color" id="model" Value="<? echo $prod['color']; ?>">	
                                                </div>
                                            </div>
                                            ...
                                            <div class="row form-group model-name">
                                                ...
                                                <div class="col-sm-9">
                                                    <input type="text" class="form-control" maxlength="30" required title="Character range should upto 30 " name="model" id="model" Value="<? echo $prod['mode_article_num']; ?>">	
                                                </div>
                                            </div>
                                             ...
                                             <div class="row form-group model-name">
                                                ...
                                                <div class="col-sm-9">
                                                    <input type="text" maxlength="30" required title="Character range should upto 30 " class="form-control" name="manufac" id="model" Value="<? echo $prod['manufacturers']; ?>">	
                                                </div>
                                            </div>
                                            <div class="row form-group model-name">
                                                    <label class="col-sm-3 label-title">Other related Information</label>
                                                    <div class="col-sm-9">
                                                            <textarea class="form-control" maxlength="5000" required title="Character range should between 1  5000 " name="related" id="textarea" rows="5"><? echo $prod['other_relateditems']; ?></textarea>	
                                                    </div>
                                            </div>
...
$isUpd = $com_obj->upload_image("photo1",$BrImg,200,200,5,3,"uploads/product/1000x600/","update");
if($isUpd){
...
$isUpd = $com_obj->upload_image("photo2",$BrImg,200,200,5,3,"uploads/product/1000x600/","update");
if($isUpd){
$NgImg=$com_obj->img_Name;
$set.=",photo2='$NgImg'";
}
...
$isUpd = $com_obj->upload_image("photo3",$BrImg,200,200,5,3,"uploads/product/1000x600/","update");
if($isUpd){
$NgImg=$com_obj->img_Name;
$set.=",photo3='$NgImg'";
}
...
$isUpd = $com_obj->upload_image("photo4",$BrImg,200,200,5,3,"uploads/product/1000x600/","update");
if($isUpd){
$NgImg=$com_obj->img_Name;
$set.=",photo4='$NgImg'";
}
...
$isUpd = $com_obj->upload_image("photo5",$BrImg,200,200,5,3,"uploads/product/1000x600/","update");
if($isUpd){
$NgImg=$com_obj->img_Name;
$set.=",photo5='$NgImg'";
}
