                                            ...
                                            <table class="table-striped table" style="width:100%; border:1px solid#dadada;">
                                                <tbody >
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td style="width:10%; text-align:left;">:</td>
                                                        <td style="width:15%;"><? $Prd_Det['place_of_origin']; ?></td>
                                                    </tr>
                                                      <tr>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td style="width:10%; text-align:left;">:</td>
                                                        <td style="width:15%;"><? $Prd_Det['color'];  ?></td>
                                                    </tr>
                                                    <tr>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td style="width:10%; text-align:left;">:</td>
                                                        <td style="width:15%;"><? $Prd_Det['hs_code'];   ?></td>
                                                    </tr>
                                            ...
                                            <table class="table-striped table" style="width:100%; border:1px solid#dadada;">
                                                <tbody >
                                                    <tr>
                                                        ...
                                                        <td style="width:10%; text-align:left;">:</td>
                                                        <td style="width:15%;"><?  $Prd_Det['manufacturers'];    ?></td>
                                                    </tr>

                                                    <tr>
                                                        <td style="width:45%;">Certificates</td>
                                                        <td style="width:10%; text-align:left;">:</td>
                                                        <td style="width:15%;"><?   $Prd_Det['certificates'];  ?></td>
                                                    </tr>
                                                    <tr>
                                                        <td style="width:45%;">Specification</td>
                                                        <td style="width:10%; text-align:left;">:</td>
                                                        <td style="width:15%;"><? $Prd_Det['specifications'];?></td>
                                                    </tr>
