                         ...
                         <div class="row form-group add-title">
                          ...
                          <div class="row form-group add-title">
                           ...
                           <div class="row form-group add-title">
                            ...
                            <label class="col-sm-3 label-title">Product Portfolio</label>

                            <div class="col-sm-9">

							<?$prod_portfolio = isset($COM['prod_portfolio'])?$COM['prod_portfolio']:'';?>

                                                        <textarea maxlength="2000" required title="Enter Product Portfolio!!Character maxlength should up to 2000" placeholder="Enter Product Portfolio upto 6000 chatacters"class="form-control" rows="3" name="prod_portfolio"><?echo $prod_portfolio;?></textarea>
                        ...
                        <div class="tab-pane" role="tabpanel" id="step3">
                          ...
                          <div class="row form-group add-title">
							...
							<?$COM_oproducts = isset($COM['other_product'])?$COM['other_product']:'';?>
                              ...
                              <textarea class="form-control" maxlength="110" placeholder="Enter main product2" required title="Characters should upto 110" rows="3" name="COM_oproducts"><?echo $COM_oproducts;?></textarea>
