                                    ...
                                    <div class="form-group">
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <textarea class="form-control" maxlength="9000" placeholder="you can mention the details such as Our team!,WhyUs!,Vision!,Mission!,Goal!,Value!" rows="3" name="COM_policy"><?echo $COM_policy;?></textarea>
                                            </div>
                                             <div class="col-md-6">
