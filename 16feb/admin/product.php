...
for($i = 0 ; $i < count($GetRecord) ; $i++) {
   ...
   @extract($GetRecord[$i]);   
	...
	$user_id= $GetRecord[$i]['userid'];

	$prod_group_name=$GetRecord[$i]['prod_group_name'];
	...
	$photo1=$GetRecord[$i]['photo1'];
        $GetRecordView=$db->singlerec("select fname,lname,company_name from register where id='$user_id'");
          $GetRecordView1=$db->singlerec("select company_name from register  where id='$user_id'");
...
if(file_exists($filesspath))
   ...
   <td width='5%'>$slno</td>
          <td  align='left'>$GetRecordView[0] $GetRecordView[1] </td>
            <td  align='left'> $GetRecordView1[0] </td>
				<td  align='left'  width='10%'>$imgsrrcc</td>

				<td  align='left' width='10%'>$categoryname</td>

				<td  align='left'  width='10%'>$prod_group_name</td>
...
?>
                    ...
                    <div id="page-content">
                        ...
                        <div class="panel">
							...
							<div class="col-sm-12 text-right"><a class="btn btn-info" href="productupd.php?upd=1">Add New</a>
