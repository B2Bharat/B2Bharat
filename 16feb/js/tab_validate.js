...
$("#btn-mc1").click(function(){
	...
	if(!checkLength($("#com_name").val(),50)){$("#com_name").focus(); swal('Required!','Company name should be with in 1-60 letters!','error'); Err++;}
          ...
          else if($.isEmptyObject($("#zip_code").val())){swal('Required!','Zip code cannot be empty!','error');  Err++;}
    ...
    if (!checkLength($("#gst_no").val(), 60)) {
      ...
      Err++;
       ...
       swal('Required!', 'PAN No. should be with in 60 characters!', 'error');
        ...
        $("#COM_intro").focus();
       swal('Required!', 'Brief Description should be with in 1000 characters!', 'error');
        Err++;}
    else if (!checkLength($("#company_policy").val(), 9000)) {
        $("#company_policy").focus();
       swal('Required!', 'Detailed Description should be with in 9000 characters!', 'error');
        Err++;}
...
$("#btn-mc3").click(function(){
	...
	if(!checkLength($("#main_product").val(),60)){$("#main_product").focus(); swal('Required!','Product name1 should be with in 1-60 letters!','error'); Err++;}
        else if (!checkLength($("#main_product2").val(), 60)) {
        $("#main_product2").focus();
       swal('Required!', 'Product name2 should be with in 1-60 letters', 'error');
        Err++;}
     else if (!checkLength($("#main_product3").val(), 60)) {
        $("#main_product3").focus();
       swal('Required!', 'Product name3 should be with in 1-60 letters', 'error');
        Err++;}
     else if (!checkLength($("#main_product4").val(), 60)) {
        $("#main_product4").focus();
       swal('Required!', 'Product name4 should be with in 1-60 letters', 'error');
        Err++;}
