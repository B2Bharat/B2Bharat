...
$que="select a.id,a.prod_no,a.userid,a.prod_briefdes,a.place_of_origin,a.prod_minprice,a.prod_expdate,a.prod_crtdate,a.max_supply_quantity,a.prod_category,a.prod_group_name,a.prod_name,a.photo1,a.featured,a.prod_status,a.permalink,a.prod_currency_loc,b.website from product as a inner join register as b on a.userid=b.id inner join company as d on a.userid=d.user_id inner join category as c on c.id=a.prod_category where a.prod_status='1'";
//print_r($que); die();
if(!empty($Main_Srch)){
