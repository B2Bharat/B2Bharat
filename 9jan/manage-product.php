                          ...
                          <table class="table table-inbox table-striped table-hover">
                            ...
                            <tbody>
                              ...
                              <tr class=" text-center">
								  ...
								  <td class="inbox-small-cells">Thumb</td>  

								  <td class="inbox-small-cells">Product Group name</td>                                 

                                  <td class="view-message ">Name</td>

								  <td class="inbox-small-cells">Category</td>

                                  <td class="view-message  inbox-small-cells">Price</td>

								  <td class="inbox-small-cells">Per Unit</td>
