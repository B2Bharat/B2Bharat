                                ...
                                <div class="wizard-title"> Categories </div>
                                    ...
                                    <div class="wizard-container">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-12">
                                             ...
                                             <h5 class="semibold text-primary">
                                                ...
                                                <i class="fa fa-sign-in"></i> Categories
                                                        ...
                                                        <p class="text-muted"> Choose the Categories Product </p>
                                                ...
                                                <div class="form-group">
													...
													<select name="prod_group" id="prod_group" class="form-control" value="<? echo $product_group; ?>" Onchange="return categ(this.value);" data-parsley-group="order" data-parsley-required>
                                            ...
                                            <div class="wizard-title"> Order And Payment </div>
                                            ...
                                            <div class="wizard-container">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-12">
                                                        ...
                                                        <p class="text-muted"> Detailed information Order And Payment </p>
                                                    ...
                                                    <div class="row">
                                                       ...
                                                       <!--<div class="col-md-3">
														...
														<div class="col-md-3">
                                                            ...
                                                            <input type="text" name="unit_price" id="unit_price" class="form-control" value="<? echo $unit_price; ?>" data-parsley-type="number" data-parsley-group="information" data-parsley-required/>
											...
											<div class="form-group">
                                               ...
                                               <div class="row">
												        ...
												        <div class="col-md-3">
                                                            ...
                                                            <input type="text" name="prod_maxprice" id="prod_maxprice" class="form-control" value="<? echo $prod_maxprice ; ?>"  data-parsley-type="number"data-parsley-group="information" data-parsley-required/>
										...
										<div class="form-group">
										   ...
										   <div class="row">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="row">
														...
														<div class="col-md-3">
                                                            ...
                                                            <input type="text" name="prod_minquantity" id="prod_minquantity" class="form-control" value="<? echo $prod_minquantity; ?>"  data-parsley-type="number"data-parsley-group="information" data-parsley-required/>
                                            ...
                                            <div class="wizard-title"> Photos & Brochure</div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-12">
                                                        ...
                                                        <h5 class="semibold text-primary">
                                                            ...
                                                            <i class="fa fa-book"></i> Pictorial Illustration

                                                        </h5>

                                                        <p class="text-muted"> Add Pictorial Illustration </p>
												...
												<div class="form-group">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-12">
                                                            ...
                                                            <select name="other_relateditems" id="other_relateditems" class="form-control" multiple>
												...
												<div class="form-group">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-12">
                                                            ...
                                                            <input type="text" name="color" id="color" class="form-control" value="<? echo $color; ?>">
                                            ...
                                            <div class="wizard-container">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-12">
                                                        ...
                                                        <p class="text-muted"> Your Product Uploaded Successfully</p>
                                            ...
                                            <div class="col-md-6">
                                                            ...
                                                            <input type="text" name="prod_group_name" id="prod_group_name" value="<? echo $prod_group_name; ?>" class="form-control" data-parsley-group="experience" data-parsley-required/>
														...
														<div class="col-md-6">
                                                            ...
                                                            <input type="text" name="prod_name" id="prod_name" value="<? echo $prod_name; ?>" class="form-control" data-parsley-group="experience" data-parsley-required/>

															<label> Product No :<span class="text-danger">*</span></label>

                                                            <input type="text" name="prod_no" id="prod_no" value="<? echo $prod_no; ?>" class="form-control" data-parsley-type="number" data-parsley-group="experience" data-parsley-required/>
													   ...
													   <div class="radio">
                                                           ...
                                                           <label> Ready to Publish : </label><br>&nbsp;&nbsp;&nbsp;&nbsp;
														...
														<div class="radio"> 
                                                           ...
                                                           <label> Save as Featured : </label><br>&nbsp;&nbsp;&nbsp;&nbsp;
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="row">
														...
														<div class="col-md-3">
                                                            ...
                                                            <input type="input" name="keyword2" class="form-control" value="<? echo $keyword2; ?>"data-parsley-group="experience" data-parsley-required/>
														...
														<div class="col-md-3">
                                                            ...
                                                            <input type="input" name="keyword3" class="form-control" value="<? echo $keyword3; ?>"data-parsley-group="experience" data-parsley-required/>
														...
														<div class="col-md-3">
                                                            ...
                                                            <input type="input" name="keyword4" class="form-control" value="<? echo $keyword4; ?>"data-parsley-group="experience" data-parsley-required/>
												...
												<div class="form-group">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-12">
                                                            ...
                                                            <textarea name="prod_gdes" id="prod_gdes" class="form-control" data-parsley-group="experience" data-parsley-required><? echo $prod_gdes; ?></textarea>
												...
												<div class="row">
                                                    ...
                                                    <div class="col-sm-12">
													 ...
													 <label> Brief Description :<span class="text-danger">*</span> </label>
                                                        ...
                                                        <textarea name="prod_briefdes" id="prod_briefdes" class="form-control" data-parsley-group="experience" data-parsley-required/><? echo $prod_briefdes; ?></textarea> 
												...
												<div class="form-group">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-12">
                                                            ...
                                                            <textarea name="prod_detaildes" id="prod_detaildes" class="form-control" data-parsley-group="experience" data-parsley-required><? echo $prod_detaildes; ?></textarea>
												...
												<div class="form-group">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-3">
                                                            ...
                                                            <input name="place_of_origin" id="place_of_origin" class="form-control" value="<? echo $place_of_origin; ?>">
														 ...
														 <div class="col-md-3">
                                                            ...
                                                            <input name="specifications" id="specifications" class="form-control" value="<? echo $specifications; ?>">
														 ...
														 <div class="col-md-3">
                                                            ...
                                                            <input name="certificates" id="certificates" class="form-control" value="<? echo $certificates; ?>">
														 ...
														 <div class="col-md-3">
                                                            ...
                                                            <input name="brand_name" id="brand_name" class="form-control" value="<? echo $brand_name; ?>">
												...
												<div class="form-group">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-3">
                                                            ...
                                                            <input name="materials" id="materials" class="form-control" value="<? echo $materials; ?>">
														 ...
														 <div class="col-md-3">
                                                            ...
                                                            <input name="hs_code" id="hs_code" class="form-control" value="<? echo $hs_code; ?>">
														 ...
														 <div class="col-md-3">
                                                            ...
                                                            <input name="mode_article_num" id="mode_article_num" class="form-control" value="<? echo $mode_article_num; ?>">
														 ...
														 <div class="col-md-3">
                                                            ...
                                                            <input name="manufacturers" id="manufacturers" class="form-control" value="<? echo $manufacturers; ?>">
											...
											<div class="wizard-title"> Packaging and Shipment </div>
                                            ...
                                            <div class="wizard-container">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-12">
                                                        ...
                                                        <p class="text-muted"> Your Packaging and Shipment Information</p>
												 ...
												 <div class="form-group">
                                                    ...
                                                    <div class="row">
												        ...
												        <div class="col-md-3">
                                                            ...
                                                            <label>Maximum Supply Capacity:<span class="text-danger">*</span></label>

                                                            <input type="text" name="max_supply_quantity" id="max_supply_quantity" class="form-control" value="<? echo $max_supply_quantity; ?>"data-parsley-type="number" data-parsley-group="other" data-parsley-required/>
                                                        ...
                                                        <div class="col-md-3">
														 ...
														 <div class="col-md-3">
															...
															<?echo $drop->get_dropdown($db,"select time,time from units where time!='' AND time is NOT NULL",$supply_duration);?> 
												...
												<div class="form-group">
                                                    ...
                                                    <div class="row">
														 ...
														 <div class="col-md-12">
                                                           ...
                                                           <textarea name="packaging_details" id="packaging_details" class="form-control" /><? echo $packaging_details; ?></textarea>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="row">
														 ...
														 <div class="col-md-6">
                                                           ...
                                                           <input name="shipment" id="shipment" class="form-control" value="<? echo $shipment; ?>"/>
												...
												<div class="form-group">
                                                    ...
                                                    <div class="row">
														 ...
														 <div class="col-md-12">
                                                           ...
                                                           <textarea name="terms_and_policy" id="terms_and_policy" class="form-control" /><? echo $terms_and_policy; ?></textarea>
												...
												<div class="form-group">
                                                    ...
                                                    <div class="row">
														 ...
														 <div class="col-md-6">
                                                           ...
                                                           <input name="warranty_period" id="warranty_period" class="form-control" value="<? echo $warranty_period; ?>"/>
