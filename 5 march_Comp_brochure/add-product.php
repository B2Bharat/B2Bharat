...
$groupinfo= $db->singlerec("select * from product where id='$user_id'");
$acn = isset($acn)?$acn:'';
$userid=$uinfo['id'];
include "include/checkPlanstatus.php";
$prod_group_id=$groupinfo['id'];
...
<ul class="list-inline pull-right">
	...
	<li><button type="button" class="btn view-more-btn-3 btn-info-full" id="btn-p3">Next</button></li>
                        ...
                        <div class="tab-pane" role="tabpanel" id="complete">
                          ...
                          <input type="hidden" name="prod_group_id"  value="<?php echo $prod_group_id; ?>">
                                 
						  <div class="row form-group add-title">
                            <label class="col-sm-3 label-title">Product Group Name <span class="required">*</span></label>
                                              <div class="col-sm-9">
                                                  <input type="text" class="form-control"   placeholder="Ente product Group name "  maxlength="40"  name="prod_group_name" id="prod_group_name" placeholder="" value="<? echo @$prod_group_name; ?>" >
						  ...
						  <div class="row form-group add-title">
						    ...
						    <div class="row form-group add-title">
                                                     ...
                                                     <div class="col-sm-9">
                                                         <textarea class="form-control" placeholder="Enter Description!  Characters should be 50 to 900 " minlength="50" maxlength="900" required title="Characters range should be 50 to 900 " name="prod_gdes" rows="5"><? echo @$prod_gdes; ?></textarea>
                                                     </div>
                                                   </div>
						  ...
						  <div class="row form-group add-title">
                            ...
                            <div class="col-sm-9">
                                <textarea class="form-control"  placeholder="Enter Description! Characters should be 50 to 900 " id="b_desc" minlength="170" maxlength="900"   name="b_des" rows="5" required/><? echo @$b_des; ?></textarea>
                            </div>
                          </div>
						  ...
						  <div class="row form-group add-title">
                            ...
                            <div class="col-sm-9">
                              <textarea required class="form-control" placeholder="Enter Description!!!  Characters should upto 6000 "  name="d_des" id="d_des" rows="5"><? echo @$d_des; ?></textarea>
                            </div>
                          </div>
