...
<!--                                                    <input type="text" class="form-control"  pattern="[a-z|A-z|0-9|\s]{1,40}" required title="Enter upto 40 characters" name="prod_group_name" id="text" value="<? echo $prod['prod_group_name']; ?>" required>-->
                                                  ...
                                                  ?>
                                                  <?  $prod_group_name=$prod['prod_group'];
                                                  $prod_group_name1=$prod['prod_group_name'];
                                                  ?>
                                                    ...
                                                    echo $drop->get_dropdown($db,"select DISTINCT prod_group, prod_group_name from product where userid='$user_id'",$prod_group_name);
                                                   ?>
                                                   <option value="0" >Other</option>
                               </select>
                                                    
                                <input type="hidden" name="tmp_group_id" value="<?php echo  $prod_group_name; ?>">
                                <input type="hidden" id="tmp_group_name" name="tmp_group_name" value="<?php echo $prod_group_name1; ?>">
...
<!--                                            <div class="row form-group model-name">
										...
										<div class="col-sm-9">
                                            ...
                                            <div class="row form-group model-name">
                                                ...
                                                <div class="col-sm-9">
                                                    <textarea class="form-control" name="prod_gdes"  placeholder="Enter Description!!!  characters should between 50 to 900 " minlength="50" maxlength="900"  title="Range of characters should between 50 to 900 "  rows="3"><? echo $prod['prod_gdes']; ?></textarea>	
                                                </div>
                                            </div>
                                            ...
                                            <div class="row form-group model-name">
                                                ...
                                                <div class="col-sm-9">
                                                    <textarea class="form-control"  placeholder="Enter Description !!!  characters should between 120 minimum to 900 maximum " minlength="120" maxlength="900" required title="Range of characters should between 50 to 900 " name="b_des"  rows="3"><? echo $prod['prod_briefdes']; ?></textarea>	
                                                </div>
                                            </div>
                                            ...
                                            <div class="row form-group model-name">
                                                ...
                                                <div class="col-sm-9">
                                                    <textarea class="form-control"  placeholder="Enter Description!!!  characters should between 50 to 900 " minlength="50" maxlength="900" required title="Range of characters should between 50 to 900 " name="d_des"  rows="3" required><? echo $prod['prod_detaildes']; ?></textarea>	
                                                </div>
                                            </div>
