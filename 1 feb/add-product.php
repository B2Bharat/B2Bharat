	...
	<li><button type="button" class="btn view-more-btn-3 btn-info-full" id="btn-p3">Next</button></li>
                        ...
                        <div class="tab-pane" role="tabpanel" id="complete">
						  ...
						  <div class="row form-group add-title">
                            ...
                            <div class="col-sm-9">
                                <textarea class="form-control"  placeholder="Enter Description! Characters should be 50 to 900 " minlength="50" maxlength="900" required title="Characters range should be 50 to 900 "  name="b_des" rows="5"><? echo @$b_des; ?></textarea>
                            </div>
                          </div>
