...
?>
            ...
            <?
				$getnewprod=$db->get_all_asso("select a.id,a.prod_no,a.userid,a.prod_name,a.prod_category,a.photo1,a.prod_minprice,a.prod_crtdate from product as a,company as b where a.userid = b.user_id AND a.photo1!='' AND a.photo1!='noimage.jpg' AND a.photo1!='noimage.png' and prod_status='1' order by id desc LIMIT 12");
		   ?>
...
<!--                                                                                <div class="item-cat font-new">
										   <span class="font-new">UnitPrice : &nbsp;<? echo $prd['unit_price']; ?></span>
										</div>
                                                                                -->
