                                    ...
                                    <fieldset>
                                        <div class="section postdetails">
                                            ...
                                            <div class="row form-group add-title">
                                                ...
                                                <div class="col-sm-9">
                                                    <input type="text" class="form-control" name="prod_group_name" id="text" value="<? echo $prod['prod_group_name']; ?>" required>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row form-group add-title">
                                             ...
                                             <div class="row form-group add-title">
                                                ...
                                                <div class="col-sm-9">
                                                    <input type="text" class="form-control" name="prod_no" id="text" value="<? echo $prod['prod_no']; ?>" required>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row form-group model-name">
                                                ...
                                                <div class="col-sm-9">
                                                    <textarea class="form-control" name="prod_gdes" id="textarea" rows="3"><? echo $prod['prod_gdes']; ?></textarea>	
                                                </div>
                                            </div>
                                            ...
                                            <div class="row form-group model-name">
                                                ...
                                                <div class="col-sm-9">
                                                    <input type="text" class="form-control" name="origin" id="model" value="<? echo $prod['place_of_origin']; ?>" required>	
                                                </div>
                                            </div>
                                            ...
                                            <div class="row form-group model-name">
                                                ...
                                                <div class="col-sm-9">
                                                    <input type="text" class="form-control" name="specif" id="model" value="<? echo $prod['specifications']; ?>" required>	
                                                </div>
                                            </div>
                                            ...
                                            <div class="row form-group model-name">
                                                ...
                                                <div class="col-sm-9">
                                                    <input type="text" class="form-control" name="certif" id="model" value="<? echo $prod['certificates']; ?>" required>	
                                                </div>
                                            </div>
                                            ...
                                            <div class="row form-group model-name">
                                                ...
                                                <div class="col-sm-9">
                                                    <input type="text" class="form-control" name="bname" id="model" value="<? echo $prod['brand_name']; ?>" required>	
                                                </div>
                                            </div>
                                            ...
                                            <div class="row form-group model-name">
                                                ...
                                                <div class="col-sm-9">
                                                    <input type="text" class="form-control" name="material" id="model" value="<? echo $prod['materials']; ?>" required>	
                                                </div>
                                            </div>
                                            ...
                                            <div class="row form-group model-name">
                                                ...
                                                <div class="col-sm-9">
                                                    <input type="text" class="form-control" name="hscode" id="model" value="<? echo $prod['hs_code']; ?>" required>	
                                                </div>
                                            </div>
                                             <div class="row form-group model-name">
                                            ...
                                            <div class="row form-group model-name">
                                                ...
                                                <div class="col-sm-9">
                                                    <input type="text" class="form-control" name="model" id="model" Value="<? echo $prod['mode_article_num']; ?>">	
                                                </div>
                                            </div>
                                             ...
                                             <div class="row form-group model-name">
                                                ...
                                                <div class="col-sm-9">
                                                    <input type="text" class="form-control" name="manufac" id="model" Value="<? echo $prod['manufacturers']; ?>">	
                                                </div>
                                            </div>
                                            <div class="row form-group model-name">
