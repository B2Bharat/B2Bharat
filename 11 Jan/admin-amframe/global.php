...
$SH_Terms=array("FOB","CIF","CNF","CAT","Others");
//$sh_Terms=array("FOB","CIF","CNF","CAT","Others");
...
$Related_items = array("1"=>"product1",
					   "2"=>"product2",
					   "3"=>"product3");
...
$PS_paymentmethod=array("T/T","L/C","D/A","D/P","Western Union","Money Gram","PayPal Cash/Cheque Other","Cash/Cheque","Other");  
//Array Shipping Terms
$PS_shipping=array("","FOB","CIF","CNF","CAT","Others");  
//Array Iam a
$PS_Im=array("Buyer","Seller","Both");
//Array Office Size
$PS_office=array("100 to 200 meter","210 to 300 meter");
//Array  total employes
$PS_totemp=array("5 to 50","50 to 500");
//Array Annual Revenue
$PS_annrevenue=array("Below US$ 1 Million","US$ 1 Million to US$ 2Million");
...
//Array Compliance
$PS_compliance=array("Regularity compliance","Safety and security","Social Compliances(CSR)");
//Array Export Percentage
$PS_percentage=array("1","2");
...
$PS_delivery=array("FOB","CFR","CIF","EXW","FAS","CIP","FCA","CPT","DEQ","DDP","DAF","DDU","Express Delivery","Others");
