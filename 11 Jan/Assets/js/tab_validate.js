...
$("#btn-p4").click(function(){
	...
	if(!checkLength($("#prod_name").val(),50) ){$("#prod_name").focus(); swal('Required!','Product name should be between 1 to 50 letters ','error'); Err++;}
	...
	else if(!checkLength($("#d_des").val(),500) ){$("#d_des").focus(); swal('Required!','Detailed Description should be between 1 to 500 letters ','error'); Err++;}
...
$("#btn-mc1").click(function(){
	...
	if(!checkLength($("#com_name").val(),50)){$("#com_name").focus(); swal('Required!','Company name should be with in 1-50 letters!','error'); Err++;}
	else if(!checkLength($("#store_name").val(),50)){$("#store_name").focus(); swal('Required!','Store name should be with in 1-50 letters!','error'); Err++;}
...
$("#btn-mc2").click(function(){
	...
	if(isEmpty($("#street").val())){$("#street").focus(); swal('Required!','Street cannot be empty!','error'); Err++;}	
	else if(isEmpty($("#off_size").val())){$("#off_size").focus(); swal('Required!','Select office size!','error'); Err++;}
	else if(isEmpty($("#start_yr").val())){$("#start_yr").focus(); swal('Required!','Company start date missing!','error'); Err++;}
	else if(!checkLength($("#policy").val(),2000)){$("#policy").focus(); swal('Required!','Company policy should be with in 2000 letters!','error'); Err++;}
	else if(isEmpty($("#terms").val())){$("#terms").focus(); swal('Required!','Company terms cannot be empty!','error'); Err++;}
...
$("#btn-mc3").click(function(){
	...
	if(isEmpty($("#main_product").val())){$("#main_product").focus(); swal('Required!','Main product cannot be empty!','error'); Err++;}
...
function btn_mc5(){
	...
	if(isEmpty( $("#buss_group").val()) ){$("#buss_group").focus(); swal('Required!','Select business group!','error'); Err++;}
