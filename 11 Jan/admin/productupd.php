                ...
                <div class="col-md-12">
					...
					<div class="col-md-6">
						...
						<label> Product No :<span class="text-danger">*</span></label>
                                                          ...
                                                          <input type="text" pattern="^[1-9][0-9]{0,9}" name="prod_no" id="prod_no" value="<? echo $prod_no; ?>" class="form-control" data-parsley-type="number" data-parsley-group="experience" data-parsley-required/>
												...
												<div class="form-group">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-12">
                                                            ...
                                                            <textarea minlength="50" maxlength="900" name="prod_gdes"  id="prod_gdes" class="form-control" data-parsley-group="experience" data-parsley-required><? echo $prod_gdes; ?></textarea>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-3">
														 ...
														 <div class="col-md-3">
                                                            ...
                                                            <input   name="specifications" pattern="[a-z|A-z|0-9|\s]{1,30}"
