...
<!--                                                           <option value="">Select Product Group</option>-->
                                                        ...
                                                        echo $drop->get_dropdown($db, "select DISTINCT prod_group_name,prod_group_name from product where prod_group_id=userid ",$prod['prod_group_name']);
...
<!--                                            <div class="row form-group model-name">
										...
										<div class="col-sm-9">
                                            ...
                                            <div class="row form-group model-name">
                                                ...
                                                <div class="col-sm-9">
                                                    <textarea class="form-control" name="prod_gdes"  placeholder="Enter Description!!!  characters should between 50 to 900 " minlength="50" maxlength="900"  title="Range of characters should between 50 to 900 " id="textarea" rows="3"><? echo $prod['prod_gdes']; ?></textarea>	
                                                </div>
                                            </div>
