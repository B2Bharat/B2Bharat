...
<div style="margin-left: 35%;">
   <a class=""  href="<?echo $siteurl."/classifieds-categories-list/$maincat/$sbcatnam1"?>">
     <h5>        <?  $imgpath= "admin/uploads/category/$tmpimag";
      ...
      <h2 ><p><?php echo $_GET['$catname']; ?></p></h3>
</div>
 ...
 <div class="panel-body pr_wrap" style="margin-left:119px;">
    ...
    foreach ($subcatg_main as $mctot_oi) {
     ...
     ?>
        ...
        <div class="cat"  alt="..." style="width:20%;float:left;  margin: 1%"  >
    <p style="text-align: center;padding-right: 140px;  "><a href="<?php  echo $sburl  ?>"><?php echo  $sbcatnam1_oi; ?></a></p>
    <?php 
        ...
        if (file_exists($imgpath)) {
            if ($image != "") {
                echo "<img src='/$imgpath' class='' style='height:120px; width:120px;'   >";
            } else {
                echo "<img src='/admin/uploads/category/noimage.jpg'  class='mr10 zm-in' >";
            }
        } else {
