              ...
              <div class="section slider">
                <div class="row" style="margin-top: -50px;">
                  <div class="wizard">
                    ...
                    <form action="add-product" id="addproct" method="post" role="form" enctype="multipart/form-data" novalidate>
...
<li><button type="button" class="btn view-more-btn-3" id="btn-p1">Next</button></li>
                        ...
                        <div class="tab-pane" role="tabpanel" id="step2">
                          ...
                          <div class="row form-group add-title">
                            ...
                            <div class="col-sm-9">
                                <input type="text" class="form-control" maxlength="8"  pattern="^[1-9][0-9]{0,7}" name="max_price" id="max_price" placeholder="" required 
...
<!--							    <?
                                ...
                                ?>-->
								  ...
								  foreach($paymenttype as $k=>$st) {
									echo "<div class='col-md-4'><label for='$st'><input type='checkbox' name='pay_method[]' value='$st' id='$st'> $st</label></div>";
								  }
								  ?>
                              </div>
                            </div>
						  ...
						  <div class="row form-group add-title">
                            ...
                            <div class="col-sm-9 row">
                              <div class="col-sm-6">
							     <div class="form-group">
									<div class="input-group">
                                                                            <input type="text" pattern="^[1-9][0-9]{0,7}" maxlength="8" class="form-control" name="ord_quan" placeholder="" value="<? echo @$ord_quan; ?>" onkeydown="return ( event.ctrlKey || event.altKey || (47<event.keyCode && event.keyCode<58 && event.shiftKey==false) || (95<event.keyCode && event.keyCode<106) || (event.keyCode==8) || (event.keyCode==9) || (event.keyCode>34 && event.keyCode<40) || (event.keyCode==46) )">
									</div>
								</div> <!-- /.form-group -->
							  </div>
							  <div class="col-sm-6">
						  ...
						  <div class="row form-group add-title">
                            <label class="col-sm-3 label-title">Time to Expire <span class="required">*</span></label>
                            <div class="col-sm-9">
	...
	<li><button type="button" class="btn view-more-btn-3" id="btn-p2">Next</button></li>
                        ...
                        <div class="tab-pane" role="tabpanel" id="step3">
						  ...
						  <div class="row form-group add-image">
                            <label class="col-sm-3 label-title">Upload product Images <small style="color:red;">(image size should be 1000x600)</small><span class="required">*</span></label>
                            <div class="col-sm-9">
                              <div class="upload-section">
                                <label class="upload-image" for="upload-image-one">
                                <input type="file" id="upload-image-one" name="photo1" accept="image/*" onchange="img_validate('upload-image-one',100,100,5,3,'img_div');" > 
								<div class=""><img src="" id="img_div"/></div>
                                </label>
								<label class="upload-image" for="upload-image-two">
                                <input type="file" id="upload-image-two" name="photo2" accept="image/*" onchange="img_validate('upload-image-two',100,100,5,3,'img_div2' );" >
								<div class=" dfgdg"><img src="" id="img_div2"/></div>
                                </label>	
								<label class="upload-image" for="upload-image-three">
                                <input type="file" id="upload-image-three" name="photo3" accept="image/*" onchange="img_validate('upload-image-three',100,100,5,3,'img_div3');">
								<div class=""><img src="" id="img_div3"></img></div>								
                                </label>
								<label class="upload-image" for="upload-image-four">
								<div class=""><img src="" id="img_div4"></img></div>
                                <input type="file" id="upload-image-four" name="photo4" accept="image/*" onchange="img_validate('upload-image-four',100,100,5,3,'img_div4');" >
                                </label>
                              </div>
                            </div>
                          </div>
                           <div class="row form-group add-image">
                                  <label class="col-sm-3 label-title">Upload product Group Image <small style="color:red;">(image size should be 1000x600)</small><span class="required">*</span></label>
                               <div class="col-sm-9">
                                   <div class="upload-section">
                                         <label class="upload-image" for="upload-image-five">
                                <input type="file" id="upload-image-five" name="photo5" accept="image/*" onchange="img_validate('upload-image-five',100,100,5,3,'img_div5');" > 
								<div class=""><img src="" id="img_div5"/></div>
                                </label>
		       ...
		       <!-- <div class="row form-group add-image">
                            ...
                            <div class="col-sm-9">
                              <div class="upload-section">
								...
								<div class=""><img src="" id="img_div6"></img></div>
									<input type="file" name="brch" id="upload-image-six" accept="image/*" onchange="img_validate('upload-image-six',1000,600,5,3,'img_div6');">
                                </label>										
                              </div>
                            </div>
                          </div> -->
	...
	<li><button type="button" class="btn view-more-btn-3 btn-info-full" id="btn-p3">Next</button></li>
                        ...
                        <div class="tab-pane" role="tabpanel" id="complete">
						  ...
						  <div class="row form-group add-title">
                                              ...
                                              <div class="col-sm-9">
                                                  ...
                                                  ?>
                                                    ...
                                                    <select class="form-control"   onchange="myFunction(this.value,this)" name="prod_group_name"  required>
                                                        <option value="">select</option>
                                                     <?php     echo $drop->get_dropdown($db,"select DISTINCT prod_group, prod_group_name from product where userid='$user_id'","selected");
                                                   ?>
                            ...
                            <div class="col-sm-9">
                              <input type="text" class="form-control"  placeholder="Ente product group name  " name="new_prod_group" id="new_prod_group" placeholder="" value="" >
                            </div>
                          </div>
						  ...
						  <div class="row form-group add-title">
                            ...
                            <div class="col-sm-9">
                              <input type="text" class="form-control"  placeholder="Ente product name  " name="prod_name" id="prod_name" placeholder="" value="<? echo @$prod_name; ?>" >
                            </div>
                          </div>
						  <div class="row form-group add-title">
                            <label class="col-sm-3 label-title">Product No <span class="required">*</span></label>
                            <div class="col-sm-9">
                                <input type="text" class="form-control" placeholder="Enter product No upto 10 digits only"  name="prod_no" maxlength="10" id="prod_no" placeholder="" value="<? echo @$prod_no; ?>" >
                            </div>
                          </div>
						  ...
						  <div class="row form-group add-title">
                            ...
                            <div class="col-sm-9 row">
							  <div class="col-md-6">
                                                              <input required type="text" maxlength="40" class="form-control" name="key1"  placeholder="Enter Keyword 1"id="key1" value="<? echo @$key1; ?>">
							   <input required type="text" maxlength="40"  class="form-control" name="key2" placeholder="Enter Keyword 2" id="key2" value="<? echo @$key2; ?>">
							   </div>
							   <div class="col-md-6">
							   <input required type="text" maxlength="40"  class="form-control" name="key3" placeholder="Enter Keyword 3" id="key3" value="<? echo @$key3; ?>">
							   <input required type="text"  class="form-control" name="key4" placeholder="Enter Keyword 4" id="key4" value="<? echo @$key4; ?>">
							   </div>
						    ...
						    <div class="row form-group add-title">
                                                     ...
                                                     <div class="col-sm-9">
                                                         <textarea class="form-control tiny"  placeholder="Enter Description!  Characters should be 50 to 900 " minlength="50" maxlength="900" required title="Characters range should be 50 to 900 " name="prod_gdes" rows="5"><? echo @$prod_gdes; ?></textarea>
                                                     </div>
                                                   </div>
						  
						  <div class="row form-group add-title">
                            <label  class="col-sm-3 label-title">Product Brief Description<span class="required">*</span></label>
                            <div class="col-sm-9">
                                <textarea  class="form-control tiny"  placeholder="Enter Description! Characters should be 50 to 900 " id="b_desc" minlength="170" maxlength="900"   name="b_des" rows="5" required/><? echo @$b_des; ?></textarea>
                            </div>
                          </div>
						  ...
						  <div class="row form-group add-title">
                            ...
                            <div class="col-sm-9">
                              <textarea required class="form-control tiny" placeholder="Enter Description!!!  Characters should upto 6000 "  name="d_des" id="d_des" rows="5"><? echo @$d_des; ?></textarea>
                            </div>
                          </div>
						  ...
						  <div class="row form-group add-title">
                            ...
                            <div class="col-sm-9">
                                <input type="text" id="address" class="form-control"  maxlength="30" placeholder="Enter your city name" name="origin" id="text" placeholder="" value="<? echo @$origin; ?>">
                            </div>
						  ...
						  <div class="row form-group add-title">
                            ...
                            <div class="col-sm-9">
                                <input type="text" class="form-control" maxlength="30" name="specif" pattern="[a-z|A-z|0-9|\s]{1,30}" id="text" placeholder="" value="<? echo @$specif; ?>">
                            </div>
                          </div>
						  ...
						  <div class="row form-group add-title">
                            ...
                            <div class="col-sm-9">
                              <input type="text" class="form-control" maxlength="30"  name="certif" id="text" placeholder="" value="<? echo @$certif; ?>">
                            </div>
                          </div>
						   ...
						   <div class="row form-group add-title">
                            ...
                            <div class="col-sm-9">
                              <input type="text" class="form-control" maxlength="30"   name="bname" id="text" placeholder="" value="<? echo @$bname; ?>">
                            </div>
                          </div>
						  ...
						  <div class="row form-group add-title">
                            ...
                            <div class="col-sm-9">
                              <input type="text" class="form-control"  maxlength="30" name="material" id="text" placeholder="" value="<? echo @$material; ?>">
                            </div>
                          </div>
						  ...
						  <div class="row form-group add-title">
                            ...
                            <div class="col-sm-9">
                                <input type="text" class="form-control"   pattern="^[1-9][0-9]{0,9}" maxlength="10" name="hscode" id="text" placeholder="Accpet upto 10 digits" value="<? echo @$hscode; ?>" onkeydown="return ( event.ctrlKey || event.altKey || (47<event.keyCode && event.keyCode<58 && event.shiftKey==false) || (95<event.keyCode && event.keyCode<106) || (event.keyCode==8) || (event.keyCode==9) || (event.keyCode>34 && event.keyCode<40) || (event.keyCode==46) )">
                            </div>
                          </div>
			   ...
			   <div class="row form-group add-title">
                            ...
                            <div class="col-sm-9">
                                <input type="text" class="form-control" maxlength="30"  name="model" id="text" placeholder="" value="<? echo @$model; ?>" onkeydown="return ( event.ctrlKey || event.altKey || (47<event.keyCode && event.keyCode<58 && event.shiftKey==false) || (95<event.keyCode && event.keyCode<106) || (event.keyCode==8) || (event.keyCode==9) || (event.keyCode>34 && event.keyCode<40) || (event.keyCode==46) )">
                            </div>
                          </div>
                          ...
                          <div class="row form-group add-title">
                            ...
                            <div class="col-sm-9">
                                <textarea class="form-control" maxlength="5000"  name="related" rows="3"><? echo @$related; ?></textarea>
                            </div>
                          </div>
			...
			<div class="row form-group add-title">
                            ...
                            <div class="col-sm-9">
                              <input type="text" maxlength="30" class="form-control" name="manufac" id="text" placeholder="" value="<? echo @$manufac; ?>">
                            </div>
                          </div>
...
<!--                                            <?
							  ...
							  foreach($PSH_Terms as $Sh) {
							    $Shl=strtolower($Sh);
								echo "<input type='radio' name='shipping_terms' value='$Shl' id='$Shl'> <label for='$Shl'>$Sh</label>";
							  }
							  ?>
						  ...
						  <div class="row form-group add-title">
                            ...
                            <div class="col-sm-9">
                                <textarea class="form-control" maxlength="30" required title="character range should be upto 30" name="pack_det" rows="5"><? echo @$pack_det; ?></textarea>
                            </div>
                          </div>
						  ...
						  <div class="row form-group add-title">
                            ...
                            <div class="col-sm-9">
                              <input type="text" class="form-control"  maxlength="30" required title="character range should be upto 30" name="shipment" id="text" placeholder="" value="<? echo @$shipment; ?>">
                            </div>
                          </div>
...
<!--						  <div class="row form-group add-title">
						  ...
						  <div class="row form-group add-title">
                            ...
                            <div class="col-sm-9 row">
							   <input type="text" maxlength="30" class="form-control" name="c_period" id="text" placeholder="" value="<? echo @$c_period; ?>">
                            </div>
                          </div>
						  ...
						  <div class="row form-group add-title">
                            ...
                            <div class="col-sm-9 row">
							   <textarea class="form-control" required title="character range should be upto 5000" maxlength="5000" name="terms" rows="5"><? echo @$terms; ?></textarea>
                            </div>
                          </div>
						  ...
						  <div class="row form-group add-title">
                            ...
                            <div class="col-sm-9 row">
							   <input type="text"  maxlength="30" class="form-control" required title="character range should be upto 30"name="w_period" id="text" placeholder="" value="<? echo @$w_period; ?>">
                            </div>
                          </div>
						  ...
						  <div class="row form-group add-title">
                            ...
                            <div class="col-sm-9 row">
							   <input type="text" maxlength="30" class="form-control" required title="character range should be upto 30" name="g_period" id="text" placeholder="" value="<? echo @$g_period; ?>">
                            </div>
                          </div>
