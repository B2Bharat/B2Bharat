...
$ln=$db->get_all_asso("select name from language where id IN(".$Prd_Det['language'].")");
$lg='';
foreach ($ln as $l)
{
$lg[] =$l['name'];
            ...
            <div class="row">
                ...
                <div class="col-md-7">
                    <div id="product-carousel" class="carousel slide" data-ride="carousel">
                        ...
                        <!-- Wrapper for slides -->
                        <div class="carousel-inner carousel-inner-1" role="listex">
                            <!-- item -->
                            <div class="item active">
                                <div class="carousel-image">
                                    <!-- image-wrapper -->
                                    <img src="<?echo $p1url;?>" alt="Featured Image" class="img-responsive" style="position: relative;
    width: 100%;">
                                </div>
                            </div>
                            <!-- item -->
                            ...
                            <div class="item">
                                <div class="carousel-image">
                                    <!-- image-wrapper -->
                                    <img src="<?echo $p2url;?>" alt="Featured Image" class="img-responsive" style="position: relative;
    width: 100%;">
                                </div>
                            </div>
                            <!-- item -->
                            ...
                            <div class="item">
                                <div class="carousel-image">
                                    <!-- image-wrapper -->
                                    <img src="<?echo $p3url;?>" alt="Featured Image" class="img-responsive" style="position: relative;
    width: 100%;">
                                </div>
                            </div>
                            <!-- item -->
                            ...
                            <div class="item">
                                <div class="carousel-image">
                                    <!-- image-wrapper -->
                                    <img src="<?echo $p4url;?>" alt="Featured Image" class="img-responsive" style="position: relative;
    width: 100%;">
                                </div>
                            </div>
                            <!-- item -->
                            ...
                            <div class="item">
                                <div class="carousel-image">
                                    <!-- image-wrapper -->
                                    <img src="<?echo $p5url;?>" alt="Featured Image" class="img-responsive" style="position: relative;
    width: 100%;">
                                </div>
                            </div>
                            <!-- item -->
                ...
                <div class="col-md-5">
                    <div class="slider-text">
                        ...
                        <?
                        $ccode = $db->singlerec("select currencycode from currency_code where id ='".$Prd_Det['prod_currency_loc']."' LIMIT 1");
                        $price1 = $Prd_Det['unit_price'];
                        if($price1 !=0)
                        $price1=$price1.' '.$ccode[0];
                        else
                        $price1="";
                        ?>
...
<!--                        <span>Min Price Rs:<? if($Prd_Det['prod_minprice']){echo $Prd_Det['prod_minprice']."<br/>";} ?></span>-->
                        <span>Price Rs:<? if($Prd_Det['unit_price']){echo $Prd_Det['unit_price']."<br/>";} ?></span>
                        <span class="icon"><i class="fa fa-clock-o"></i><? echo date("d M Y", strtotime($Prd_Det['prod_expdate'])); ?></span>&nbsp;
                         <? $city=$db->singlerec("select city_name from city where city_auto_id='$Prd_Det[city]'"); ?>
...
<!--										<tr>
                                        ...
                                        <tr>
                                            <td><strong>MinimumOrder</strong></td>
                                            <td><strong>:</strong></td>
                                        ...
                                        <tr>
                                            ...
                                            <td><strong>:</strong></td>
                                            <td><? echo $Prd_Det['max_supply_quantity']; ?></td>
                                        </tr>
                                        <tr>
                                            <td><strong>Payment Terms</strong></td>
                                            <td><strong>:</strong></td>
                                            <td><? echo $Prd_Det['payment_type']; ?></td>
                                        </tr>
                        ...
                        <!-- short-info -->
                        <!-- contact-with -->
                        <div class="contact-with" oncontextmenu="return false;" id="test" onmousedown='return false;' onselectstart='return false;'>
                            <h4>Contact with </h4>
        ...
        <!-- slider -->
        <div class="description-info" oncontextmenu="return false;" id="test" onmousedown='return false;' onselectstart='return false;'>
            <div class="row">
                <!-- description -->
                <div class="col-md-8">
...
<!--                        <p align="justify"><? echo $Prd_Det['prod_detaildes']; ?></p>-->
                ...
                <div class="col-md-4">
                    <div class="short-info">
                        <ul>
                                                   <!--<li><i class="fa fa-envelope-o" aria-hidden="true"></i> example@domain.com</li>-->							 <?PHP
                            if ($Prd_Det['website'] <> 'NULL') {
                                ...
                                ?>							 
                                <li><a href="<?echo $website;?>" target="_blank"><i class="fa fa-globe" aria-hidden="true"></i><?echo $Prd_Det['website'];?></a></li>
                         <? $city=$db->singlerec("select city_name from city where city_auto_id='$Prd_Det[city]'"); ?>							 <?PHP } ?>							 
            ...
            <div class="row">
                <div class="well" style="padding-bottom:0;">
                    <div class="adpost-details">
                        ...
                        <!-- Nav tabs -->
                        <ul class="nav nav-tabs" role="tablist" oncontextmenu="return false;" id="test" onmousedown='return false;' onselectstart='return false;'>
...
<!--                            <li role="presentation"><a href="#reviews" aria-controls="reviews" role="tab" data-toggle="tab">Reviews</a></li>-->
                        ...
                        <!-- Tab panes -->
                        <div class="tab-content well" oncontextmenu="return false;" id="test" onmousedown='return false;' onselectstart='return false;'>
                                    ...
                                    <div class="col-sm-6">
                                        <div class="responsive-table">
                                            <table class="table-striped table" style="width:100%; border:1px solid#dadada;">
                                                <tbody >
                                                    <tr>
                                                        <td  style="width:45%;">Product NO.</td>
                                                        <td  style="text-align: left;">:</td>
                                                        <td style="width:15%;"><? echo $Prd_Det['prod_no']; ?></td>
                                                    ...
                                                    <!-- code by santosh-->
                                                    <tr>
                                                        <td style="width:45%;">Maximum Price</td>
                                                        <td style="width:10%; text-align:left;">:</td>
                                                        <td style="width:15%;"><?  echo $Prd_Det['prod_maxprice'];   ?></td>
                                                    </tr>

                                                    <tr>
                                                        <td style="width:45%;">Current Unit</td>
                                                        <td style="width:10%; text-align:left;">:</td>
                                                        <td style="width:15%;"><? echo $Prd_Det['unit_price'];   ?></td>
                                                    </tr>

                                                    <tr>
                                                        <td style="width:45%;">Origin</td>
                                                        <td style="width:10%; text-align:left;">:</td>
                                                        <td style="width:15%;"><? if($Prd_Det['place_of_origin']){echo $Prd_Det['place_of_origin']."<br/>";} ?></td>
                                                    </tr>
                                                    <tr>
                                                        <td style="width:45%;">Brand Name</td>
                                                        <td style="width:10%; text-align:left;">:</td>
                                                        <td style="width:15%;"><? if($Prd_Det['brand_name']){echo $Prd_Det['brand_name']."<br/>";} ?></td>	
                                                    </tr>

                                                    <tr>
                                                        <td style="width:45%;">Colour</td>
                                                        <td style="width:10%; text-align:left;">:</td>
                                                        <td style="width:15%;"><? if($Prd_Det['color']){echo $Prd_Det['color']."<br/>";} ?></td>
                                                    </tr>
                                                    <tr>
                                                        <td style="width:45%;">Material</td>
                                                        <td style="width:10%; text-align:left;">:</td>
                                                        <td style="width:15%;"><? echo $Prd_Det['materials'];   ?></td>	
                                                    </tr>
                                                    <tr>
                                                        <td style="width:45%;">Model NO</td>
                                                        <td style="width:10%; text-align:left;">:</td>
                                                        <td style="width:15%;"><? echo $Prd_Det['mode_article_num'];?></td>
                                                    </tr>
                                                    <tr>
                                                        <td style="width:45%;">HS Code</td>
                                                        <td style="width:10%; text-align:left;">:</td>
                                                        <td style="width:15%;"><? if($Prd_Det['hs_code']){echo $Prd_Det['hs_code']."<br/>";} ?></td>
                                                    </tr>
                                    ...
                                    <div class="col-sm-6">
                                        <div class="responsive-table">
                                            <table class="table-striped table" style="width:100%; border:1px solid#dadada;">
                                                <tbody >
                                                    <tr>
                                                        <td style="width:45%;">Business Type</td>
                                                        <td style="width:10%; text-align:left;">:</td>
                                                        <td style="width:15%;"><? if($Prd_Det['manufacturers']){echo $Prd_Det['manufacturers']."<br/>";} ?></td>
                                                    </tr>

                                                    <tr>
                                                        <td style="width:45%;">Certificates</td>
                                                        <td style="width:10%; text-align:left;">:</td>
                                                        <td style="width:15%;"><? if($Prd_Det['certificates']){echo $Prd_Det['certificates']."<br/>";} ?></td>
                                                    </tr>
                                                    <tr>
                                                        <td style="width:45%;">Specification</td>
                                                        <td style="width:10%; text-align:left;">:</td>
                                                        <td style="width:15%;"><? if($Prd_Det['specifications']){echo $Prd_Det['specifications']."<br/>";} ?></td>
                                                    </tr>

                                                    <tr>
                                                        <td style="width:45%;">Production Capacity</td>
                                                        <td style="width:10%; text-align:left;">:</td>
                                                        <td style="width:15%;"><? echo $Prd_Det['max_supply_quantity'];   ?></td>
                                                    </tr>

                                                    <tr>
                                                        <td style="width:45%;">Packaging Details</td>
                                                        <td style="width:10%; text-align:left;">:</td>
                                                        <td style="width:15%;"><? echo $Prd_Det['packaging_details'];   ?></td>
                                                    </tr>
                                                    <tr>
                                                        <td style="width:45%;">Shipment</td>
                                                        <td style="width:10%; text-align:left;">:</td>
                                                        <td style="width:15%;"><?   echo $Prd_Det['shipment'];   ?></td>
                                                    </tr>
                                                    <tr>
                                                        <td style="width:45%;">Expected Deleivery</td>
                                                        <td style="width:10%; text-align:left;">:</td>
                                                        <td style="width:15%;"><?  echo $Prd_Det['prod_expdate'];  ?></td>   
                                                    </tr>
                                                    <tr>
                                                        <td style="width:45%;">Contract period</td>
                                                        <td style="width:10%; text-align:left;">:</td>
                                                        <td style="width:15%;"><? echo $Prd_Det['contract_period'];    ?></td>
                                                    </tr>  
                                                    <tr>
                                                        <td style="width:45%;">Guarenty</td>
                                                        <td style="width:10%; text-align:left;">:</td>
                                                        <td style="width:15%;"><? echo $Prd_Det['garranty_period'];   ?></td>
                                                    </tr>
                                                    <tr>
                                                        <td style="width:45%;">Warrenty</td>
                                                        <td style="width:10%; text-align:left;">:</td>
                                                        <td style="width:15%;"><? echo $Prd_Det['warranty_period'];  ?></td>
                                                    </tr>
                            ...
                            <div role="tabpanel" class="tab-pane" id="video">
                                <h4>Video<h4>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-sm-6 col-md-3 col-lg-3">
                                                    ...
                                                    <div class="featured">
                                                        ...
                                                        <!-- ad-info -->
                                                        <div class="ad-info">
                                                            <h3 class="item-price">Unit Price Rs:<? echo $price1; ?></h3>
                                                        ...
                                                        <div class="ad-meta">
                                                            ...
                                                            <div class="user-option pull-right">
                                                                <? $city=$db->singlerec("select city_name from city where city_auto_id='$Prd_Det[city]'"); ?>
                                                                 ...
                                                                 <a href="#" data-toggle="tooltip" data-placement="top" title="" data-original-title="<? echo $city['city_name'];?>,<?echo ucfirst($com_obj->getCountry($Prd_Det['country']));?>"><i class="fa fa-map-marker"></i> </a>
                                                                            <a href="#" data-toggle="tooltip" data-placement="top" title="" data-original-title="<?echo ucwords($mempack[0]);?>"><i class="fa fa-suitcase"></i> </a>																					
                                                            </div>
                                                            <!-- item-info-right -->
                                                        </div>
                                                        <!-- ad-meta -->
                                        ...
                                        <div role="tabpanel" class="tab-pane" id="others">
                                            <h4>Others</h4>
                                             <p align="justify"><? echo $Prd_Det['other_relateditems']; ?></p>
                                        </div>
                                        ...
                                        <div class="col-md-9 row">
                                            <div class="row"  style="margin-right:-320px;">
                                                <div class="well" style="padding-bottom:0;">
                                                    <div class="row">
                                                        <!-- featured-top -->
                                                        <div class="col-sm-12">
                                                    ...
                                                    <div id="myCarousel-4" class="carousel slide">
                                                        <div class="carousel-inner">
                                                            ...
                                                            $price1=$pp['unit_price'].' '.$ccode[0];
                                                            $origin=$pp['place_of_origin'].' '.$ccode[0];
                                                            ...
                                                            <div class="col-sm-6 col-md-3 col-lg-3">
                                                                ...
                                                                <div class="featured">
                                                                    ...
                                                                    <!-- ad-info -->
                                                                    <div class="ad-info">
                                                                        <h3 class="item-price"> Price Rs.:<? echo $price1; ?></h3> 
