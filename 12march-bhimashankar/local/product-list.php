...
<div class="col-md-4 product_sec byuinglist">    
			<div class="prd_wrapper">
			   ...
			   <div class="col-md-6 pr_img">
					<h2><a href="<? echo $siteurl; ?>/buying-leads-detail/<? echo $perm; ?>/<? echo $com_obj->encid($BL['id']); ?>"><?echo ($BL['offer_name']>15)?ucfirst(substr($BL['offer_name'],0,16).'...'):$BL['offer_name'];?>saaS</a></h2>
...
?>
		...
		<div class="col-md-4 product_sec" style="display: table-cell;">    
			   ...
			   <div class="col-md-6 pr_img">
			        <?php if($ownerweburl!='') {  ?>
					<h2><a target="_blank"  href="<?php $link = $ownerweburl;$link = (0 === strpos($link, 'http')) ? $link : 'http://' . $link; echo $link;?>"><? echo substr($pname,0,15); ?></a></h2>
					<?php }else{ ?>
					...
					<a href="<?php $link = $ownerweburl;$link = (0 === strpos($link, 'http')) ? $link : 'http://' . $link; echo $link;?>"><img src="<? echo $siteurl; ?>/uploads/product/1000x600/<? echo $prd['photo1']; ?>" alt="<? echo $pname;//$name; ?>" class="img-responsive"></a>
					<?php }else{ ?>
