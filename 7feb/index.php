						...
						<?php foreach($getnewprod_sub as $hyut)
						 {
                           ...
                           <li id="menu-item-4">
							...
							<li id="menu-item-view">
                                                        <?php echo "<a class='view-more-cats'  href='$siteurl/category-details/$encid/$perma' class='btn btn-global' ><strong>View More</strong></a>";?>
							</li>  
                              </ul>
                           </li>
...
<!--                  <h5> User Id: <?php echo $trade['user_id'];?></h5>-->
        ...
        <div class="block block-supplier">
          <div class="panel panel-default">
            <div style="color:white;" class="panel-heading">
              <h4 style="color:white;">Premium Suppliers Profile</h4>
            </div>
...
<!--       <div class="block block-news news_wraper">
          <div class="panel panel-default">
            ...
            <div style="color:white;" class="panel-heading">
              <h3 style="color:white;" ><i class="fa fa-globe"></i> Latest News</h3>
            </div>
...
<!--          <div class="block block-news news_wraper">
          <div class="panel panel-default">
            <div style="color:white;" class="panel-heading">
             <h3 style="color:white;"> New Trade Shows
            </div>
  ...
  <div class="banner_outer">
		  ...
		  <div class="featured_title_sec" >
			...
			?>
              ...
              <li >
                <div class="cl_sec">
                  <h3 class="item-title"><a target="_blank" href="<? echo $siteurl; ?>/product-detail/<? echo $encid; ?>/<? echo $perm; ?>"><?echo (strlen($newprod['prod_name'])>14)?substr(ucwords($newprod['prod_name']),0,50).'...':ucwords($newprod['prod_name']);?></a></h3>
...
<!--        <li><a href="#tab-3" data-toggle="tab" aria-controls="tab-2" role="tab" title="" aria-expanded="false" data-original-title="Latest Buying leads">Latest Buying leads</a></li>-->
    </ul>
					...
					<li>
                      <div class="cl_sec">
                       <a target="_blank" href="<?echo $siteurl;?>/selling-leads-detail/<?echo strtolower(str_replace(' ','-',$sellingprod['offer_name']));?>/<?echo $com_obj->encid($sellingprod['id']);?>">
                        <h4><? echo substr($sellingprod['offer_name'],0,30).'...'; ?></h4>
                        </a>
                         <a target="_blank" href="<?echo $siteurl;?>/selling-leads-detail/<?echo strtolower(str_replace(' ','-',$sellingprod['offer_name']));?>/<?echo $com_obj->encid($sellingprod['id']);?>">
						 <img src="<?echo $siteurl;?>/uploads/SL_images/banner1/<?echo $sellingprod['photo1'];?>"/></a>
                        <p class="des_sec"><? echo substr($sellingprod['brief_description'],0,70); ?></p>
                        <div class="rating_sec"><img src="images/rating.jpg"/></div>
                        <a target="_blank" href="<?echo $siteurl;?>/selling-leads-detail/<?echo strtolower(str_replace(' ','-',$sellingprod['offer_name']));?>/<?echo $com_obj->encid($sellingprod['id']);?>">Price.  <? echo $sellingprod['base_price']; ?></a></div>
                    </li>
                <?
				 }
		        ?>
		...
		?>
		            <li>
                      <div class="cl_sec">
                        ...
                        <div class="rating_sec"><img src="images/rating.jpg"/></div>
                        <a target="_blank" href="<? echo $siteurl; ?>/buying-leads-detail/<? echo $perm; ?>/<? echo $com_obj->encid($buyinglead['id']); ?>">Price  <? echo $buyinglead['price']; ?></a></div>
                    </li>
		<?
		   }
		   ?>
  ...
  <div class="container">
    <div class="row">
      <div class="our_global_sec">
		...
		<?
			$logos = $db->get_all("select * from company where active_status='1' limit 20");
		...
		?>
		  ...
		  ?>
                       <a href="<?php echo $logos[$i]['website'];?>" target="_blank"><img src="<?echo $logourl;?>" alt="" class="img-respocive" width="160" style="border: 3px; border-style: double;" ></a>
		...
		?>
            ...
            <li>
              ...
              <a target="_blank" href="<? echo $siteurl; ?>/product-detail/<? echo $encid; ?>/<? echo $perm; ?>">
                <h4><?echo (strlen($newprod['prod_name'])>14)?substr(ucwords($newprod['prod_name']),0,30):ucwords($newprod['prod_name']);?></h4>
				</a>
                <a target="_blank" href="<? echo $siteurl; ?>/product-detail/<? echo $encid; ?>/<? echo $perm; ?>"><img src="<? echo $siteurl; ?>/uploads/product/1000x600/<?echo $newprod['photo1'];?>" alt="" class="img-respocive"></a>
