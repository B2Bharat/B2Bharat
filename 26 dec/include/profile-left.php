                           ...
                           <div class="panel-body">
                              <table class="table">
                                 <tbody>
                                    <tr>
                                       <td>
                                          <a id='add-buying-offer' href="<?echo $siteurl;?>/add-selling-offer">Want to sell</a>
                                       </td>
                                    </tr>
                                    <tr>
                                       <td>
                                          <a id='manage-buying-leads' href="<?echo $siteurl;?>/manage-selling-leads">Manage offers</a>  <span class="label label-info">5</span> 
                                       </td>
                                    </tr>
                                 </tbody>
                              </table>
