	  ...
	  <?}?>
	     <div class="category-info">
				...
				<div class="ad-item row ad-item-selling-list">
					<div class="item-image-box col-sm-12 col-md-5">
						...
						<div class="ad-info">							
							<h4 class="item-title"><a target="_blank" href="<?echo $siteurl;?>/selling-leads-detail/<?echo strtolower(str_replace(' ','-',$SL['offer_name']));?>/<?echo $com_obj->encid($SL['id']);?>"><? echo ucwords($SL['offer_name']); ?></a></h4>
						...
						<div class="ad-meta ad-meta-selling-list">
							<div class="meta-content">
								 <span class="dated"><a href="#">Posted On: <?echo date("d-M-y",strtotime($SL['post_date']));?></a></span> 
                                                                 <a target="_blank" href="<?echo $siteurl;?>/selling-leads-detail/<?echo strtolower(str_replace(' ','-',$SL['offer_name']));?>/<?echo $com_obj->encid($SL['id']);?>" class="btn view-more-btn-2-1 ml20">More Details </a>
		...
		<span class="tag  ml20">
          <input type="checkbox" name="send_enqs[]" value="<?echo $SL['email'];?>">
							...
							<button onclick="setToemail('<?echo $SL['email'];?>', '<?echo ucfirst($SL['fname']);?>');" class="btn view-more-btn-2-2 ml20" data-toggle="modal" data-target="#send-an-inquiry" ><i class="fa fa-paper-plane-o" aria-hidden="true"></i>
                                Send Enquiry</button>
