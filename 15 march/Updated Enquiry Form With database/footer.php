...
<!--                                             <input type="hidden" name="enq_quantity2"  id="enq_quantity2" value="">-->
							  ...
							  foreach($currency_value as $St) {
							    $Stl=strtolower($St);
								echo "<input type='radio' name='currency_value' value='$Stl' id='$Stl'> <label for='$Stl'>$St</label>";
							  }
							  ?>
                            ...
                            <div class="col-sm-9 user-type location">
							  ...
							  foreach($enq_supplier_location as $St) {
							    $Stl=strtolower($St);
								echo "<input type='radio' name='enq_supplier_location' value='$Stl' id='$Stl'> <label for='$Stl'>$St</label>";
							  }
							  ?>
                            </div>
                          </div>
                            ...
                            <div class="col-sm-9 user-type location">
							  ...
							  foreach($enq_Requirement_urgency as $St) {
							    $Stl=strtolower($St);
								echo "<input type='radio' name='enq_Requirement_urgency' value='$Stl' id='$Stl'> <label for='$Stl'>$St</label>";
                            ...
                            <div class="col-sm-9 user-type location">
							  ...
							  foreach($enq_Requirement_frequency as $St) {
							    $Stl=strtolower($St);
								echo "<input type='radio' name='enq_Requirement_frequency' value='$Stl' id='$Stl'> <label for='$Stl'>$St</label>";
                            ...
                            <div class="col-sm-9 user-type location">
							  ...
							  foreach($enq_Requirement_purchase as $St) {
							    $Stl=strtolower($St);
								echo "<input type='radio' name='enq_Requirement_purchase' value='$Stl' id='$Stl'> <label for='$Stl'>$St</label>";
